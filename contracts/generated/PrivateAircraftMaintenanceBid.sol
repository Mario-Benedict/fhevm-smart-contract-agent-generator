...
contract PrivateAircraftMaintenanceBid is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function submitBid(
        ...
        bidId = bidCount++;
        bids[bidId] = MROBid({
            rfpId: rfpId, mroProvider: msg.sender,
            laborCostUSD: labor, partsCostUSD: parts,
            turnaroundDays: tat, qualityScoreBps: quality,
            totalBidUSD: total, submitted: true, disqualified: false
        });
