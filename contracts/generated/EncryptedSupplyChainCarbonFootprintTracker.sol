...
contract EncryptedSupplyChainCarbonFootprintTracker is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createSupplierProfile(
        ...
        id = supplierCount++;
        suppliers[id] = SupplierEmissionProfile({
            supplier: supplier, tier: tier, supplierRef: supplierRef,
            scope1tCO2e: FHE.asEuint64(0), scope2tCO2e: FHE.asEuint64(0), scope3tCO2e: FHE.asEuint64(0),
            offsetstCO2e: FHE.asEuint64(0), carbonIntensityScore: FHE.asEuint64(0),
            sbtiAlignmentScore: FHE.asEuint16(0), netZeroStatus: NetZeroStatus.NotStarted,
            reportingYear: reportingYear, verified: false
        });
        FHE.allowThis(suppliers[id].scope1tCO2e); FHE.allow(suppliers[id].scope1tCO2e, supplier);
