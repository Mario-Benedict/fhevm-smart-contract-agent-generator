...
contract PrivateHospitalCapitalEquipmentLease is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createEquipmentLease(
        ...
        id = leaseCount++;
        leases[id] = EquipmentLease({
            lessor: msg.sender, hospital: hospital, equipmentType: equipmentType,
            serialNumber: serialNumber, leaseType: leaseType, originalCostUSD: origCost,
            monthlyLeaseRateUSD: monthlyRate, totalLeaseCommitmentUSD: totalCommitment,
            residualValueUSD: residualVal, maintenanceCostReserveUSD: maintReserve,
            utilizationRateBps: FHE.asEuint16(0), totalPaidUSD: FHE.asEuint64(0),
            leaseStart: block.timestamp, leaseEnd: block.timestamp + durationMonths * 30 days,
            purchaseOptionExercised: false
        });
