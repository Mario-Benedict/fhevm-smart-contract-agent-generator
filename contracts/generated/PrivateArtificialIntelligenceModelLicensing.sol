...
contract PrivateArtificialIntelligenceModelLicensing is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createLicense(
        ...
        id = licenseCount++;
        licenses[id] = AIModelLicense({
            modelDeveloper: msg.sender, licensee: licensee, modelType: modelType,
            licenseType: licenseType, modelRef: modelRef, annualLicenseFeeUSD: annualFee,
            perCallPriceUSD: perCall, totalCallsUsed: FHE.asEuint64(0),
            trainingDataValueUSD: trainingValue, accuracyBenchmarkBps: accuracy,
            fineTuningRoyaltyBps: ftRoyalty, totalRevenueAccruedUSD: FHE.asEuint64(0),
            active: true, licenseStart: block.timestamp, licenseEnd: block.timestamp + durationDays * 1 days
        });
