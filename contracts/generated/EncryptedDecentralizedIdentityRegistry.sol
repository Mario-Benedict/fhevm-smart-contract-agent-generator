...
contract EncryptedDecentralizedIdentityRegistry is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function issueIdentity(
        ...
        identities[subject] = IdentityRecord({
            subject: subject, kycTier: kycTier, amlRiskScore: aml,
            accreditationScore: accred, ageVerified: age, revoked: FHE.asEuint8(0),
            credentialExpiry: expiry, issuer: msg.sender, issuedAt: block.timestamp
        });
