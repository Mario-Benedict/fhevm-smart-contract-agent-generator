...
contract PrivateElectricGridDemandResponse is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function enroll(
        ...
        participants[msg.sender] = DRParticipant({
            participant: msg.sender, pType: pType, zone: zone,
            baselineKwh: baseline, maxReductionKwh: maxReduction,
            minPaymentPerKwh: minPayment, totalEarned: FHE.asEuint64(0),
            reliabilityScore: FHE.asEuint64(500), enrolled: true
        });
