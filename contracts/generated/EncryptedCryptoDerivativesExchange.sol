...
contract EncryptedCryptoDerivativesExchange is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function openPosition(
        ...
        positions[posKey] = Position({
            ...
            sizeUSD: size, entryPrice: mkt.markPriceUSD,
            margin: actualMargin, unrealisedPnL: FHE.asEuint64(0),
            liquidationPrice: liqPrice, cumulativeFunding: FHE.asEuint64(0), open: true
        });
        accounts[msg.sender].availableMargin = FHE.sub(accounts[msg.sender].availableMargin, actualMargin);
