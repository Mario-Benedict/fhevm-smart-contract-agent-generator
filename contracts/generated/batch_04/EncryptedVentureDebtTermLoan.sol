...
contract EncryptedVentureDebtTermLoan is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createFacility(
        ...
        VentureDebtFacility storage _s0 = facilities[facilityId];
        _s0.borrower = borrower;
        _s0.status = LoanStatus.TERM_SHEET;
        _s0.principalAmount = principal;
        _s0.interestRateBps = interestRate;
        _s0.pikInterestBps = pikRate;
        _s0.warrantCoveragePercent = warrantCoverage;
        _s0.warrantStrikePrice = warrantStrike;
        _s0.monthlyRevenueCovenant = mrrCovenant;
        _s0.cashRunwayCovenant = cashCovenant;
        _s0.outstandingBalance = principal;
        _s0.accruedInterest = FHE.asEuint64(0);
        _s0.pikAccrued = FHE.asEuint64(0);
        _s0.prepaymentPremiumBps = prepaymentPremium;
        _s0.endOfTermPayment = etp;
        _s0.fundingDate = block.timestamp;
