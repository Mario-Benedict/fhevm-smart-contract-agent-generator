...
contract EncryptedStudentLoanScheme is ZamaEthereumConfig, Ownable {
    ...
    function issueLoan(
        ...
        loans[id].university = university;
        loans[id].principalAmount = principal;
        loans[id].accruedInterest = FHE.asEuint64(0);
        loans[id].totalRepaid = FHE.asEuint64(0);
        loans[id].annualIncomeCurrent = FHE.asEuint64(0);
        loans[id].repaymentRateBps = repayRate;
        loans[id].drawdownDate = block.timestamp;
        loans[id].inRepayment = false;
