...
contract EncryptedPrivateEquityVehicle is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createFund(
        ...
        id = fundCount++;
        FundOfFund storage _s0 = funds[id];
        _s0.fundName = name;
        _s0.vintage = vintage;
        _s0.targetSizeUSD = target;
        _s0.committedCapital = FHE.asEuint64(0);
        _s0.calledCapital = FHE.asEuint64(0);
        _s0.navUSD = FHE.asEuint64(0);
        _s0.distributedUSD = FHE.asEuint64(0);
        _s0.projectedIRRBps = FHE.asEuint64(1500);
        _s0.managementFeeBps = mgmtFee;
        _s0.carriedInterestBps = carry;
        _s0.preferredReturnBps = hurdle;
        _s0.fundraisingClosed = false;
