...
contract EncryptedTelemedicineConsultationFee is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerDoctor(
        ...
        doctors[msg.sender].licenseNumber = license;
        doctors[msg.sender].specialty = specialty;
        doctors[msg.sender].standardFeeUSD = fee;
        doctors[msg.sender].qualityScore = FHE.asEuint32(500);
        doctors[msg.sender].patientSatisfaction = FHE.asEuint32(0);
    ...
    function bookConsultation(
        ...
        consultations[id].patient = msg.sender;
        consultations[id].doctor = doctor;
        consultations[id].consultType = consultType;
        consultations[id].insurancePlan = plan;
        consultations[id].grossFeeUSD = d.standardFeeUSD;
        consultations[id].insuranceReimbursement = insurancePortion;
        consultations[id].patientCopayUSD = copay;
        consultations[id].sessionDurationMins = duration;
        consultations[id].patientRating = FHE.asEuint16(0);
        consultations[id].sessionDate = block.timestamp;
        consultations[id].completed = false;
