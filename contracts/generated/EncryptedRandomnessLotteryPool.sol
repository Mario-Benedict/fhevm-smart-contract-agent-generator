...
contract EncryptedRandomnessLotteryPool is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function openRound(
        ...
        rounds[roundId] = LotteryRound({
            ticketPriceUSD: price,
            jackpotPoolUSD: FHE.asEuint64(0),
            operatorFeeUSD: FHE.asEuint64(0),
            winningTicketHash: FHE.asEuint64(0),
            totalTicketsSold: FHE.asEuint32(0),
            maxTicketsPerWallet: maxPer,
            drawBlock: drawBlock,
            drawn: false,
            claimed: false
        });
