...
contract PrivateTelecommunicationsSpectrumAuction is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createLicense(
        ...
        specId = licenseCount++;
        licenses[specId] = SpectrumLicense({
            licenseId: licenseId, band: band, geography: geography,
            reservePriceUSD: reserve, winningBidUSD: FHE.asEuint64(0),
            minimumBid: minBid, bandwidthMHz: bandwidth,
            coveragePopulation: population, licenseTermYears: licenseTermYears,
            auctionOpen: true, settled: false, winner: address(0)
        });
    ...
    function qualifyBidder(
        ...
        FHE.allow(bidders[bidder].financialGuaranteeUSD, bidder);
