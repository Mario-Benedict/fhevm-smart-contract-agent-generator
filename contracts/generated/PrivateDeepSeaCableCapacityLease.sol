...
contract PrivateDeepSeaCableCapacityLease is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createLease(
        ...
        leaseId = leaseCount++;
        leases[leaseId] = CapacityLease({
            cableId: cableId, lessee: lessee, fiberType: fiberType, allocatedGbps: gbps,
            annualLeaseRateUSD: rate, restorationPriority: priority,
            totalSLAPenaltiesUSD: FHE.asEuint64(0),
            leaseStart: block.timestamp, leaseEnd: block.timestamp + durationDays * 1 days, active: true
        });
