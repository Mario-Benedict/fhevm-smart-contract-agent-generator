...
contract EncryptedSovereignWealthFundESG is ZamaEthereumConfig, AccessControl, ReentrancyGuard {
    ...
    function addPosition(
        ...
        positions[positionId] = PortfolioPosition({
            assetClass: assetClass,
            sector: sector,
            esgRating: rating,
            ...
            esgScore: esgScore,
            carbonFootprintTons: carbonFootprint,
            targetAllocationBps: targetAllocation,
            actualAllocationBps: actualAllocationBps,
            deviationBps: deviationBps,
            greenBondEligible: greenBondEligible,
            excluded: false,
            active: true
        });
