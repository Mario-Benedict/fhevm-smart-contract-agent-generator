...
contract EncryptedPrivateFundraiserCampaign is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createCampaign(
        ...
        campaigns[id] = Campaign({
            beneficiary: beneficiary, title: title, description: description,
            goalAmountUSD: goal, raisedAmountUSD: FHE.asEuint64(0), donorCount: FHE.asEuint64(0),
            milestone1USD: m1, milestone2USD: m2, milestone1Released: FHE.asEuint64(0),
            milestone2Released: FHE.asEuint64(0), status: CampaignStatus.Active,
