...
contract PrivateSupplyChainFinance is ZamaEthereumConfig, Ownable {
    ...
    function submitInvoice(
        ...
        invoices[id] = Invoice({
            supplier: msg.sender, buyer: buyer, invoiceAmount: amount,
            discountRateBps: discount, fundedAmount: FHE.asEuint64(0),
            lender: address(0), dueDate: block.timestamp + dueDays * 1 days,
            fundedAt: 0, status: InvoiceStatus.Pending
        });
