...
contract PatentRightsBidding is ZamaEthereumConfig, Ownable {
    ...
    function listPatent(
        ...
        id = patentCount++;
        patents[id] = Patent({
            holder: msg.sender, title: title, ipfsMetadataHash: metadataHash,
            reservePrice: reserve, highestBid: FHE.asEuint64(0),
            highestBidder: address(0), deadline: block.timestamp + durationDays * 1 days,
            auctioned: false, exclusive: exclusive
        });
