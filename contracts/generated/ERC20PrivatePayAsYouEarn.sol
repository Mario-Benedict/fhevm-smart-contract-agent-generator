...
contract ERC20PrivatePayAsYouEarn is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerEmployee(
        ...
        employees[employee] = EmployeeRecord({
            grossSalaryMonthly: gross, taxCodeMultiplier: taxCode,
            taxWithheldYTD: FHE.asEuint64(0), netPayYTD: FHE.asEuint64(0),
            niEmployeeYTD: FHE.asEuint64(0), niEmployerYTD: FHE.asEuint64(0),
            tokenBalance: FHE.asEuint64(0), active: true,
            taxYear: block.timestamp / 365 days
        });
