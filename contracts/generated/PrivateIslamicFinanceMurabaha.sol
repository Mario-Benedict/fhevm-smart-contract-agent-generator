...
contract PrivateIslamicFinanceMurabaha is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createMurabahaContract(
        ...
        euint64 totalPrice = FHE.add(cost, profit);
        ...
        contracts[id] = MurabahaContract({
            ...
            amountPaid: FHE.asEuint64(0),
            remainingBalance: totalPrice,
            totalInstallments: numInst,
            installmentsPaid: FHE.asEuint32(0),
        ...
        FHE.allow(contracts[id].costPrice, msg.sender);
