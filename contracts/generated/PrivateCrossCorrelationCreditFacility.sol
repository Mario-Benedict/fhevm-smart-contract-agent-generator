...
contract PrivateCrossCorrelationCreditFacility is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createFacility(
        ...
        id = facilityCount++;
        facilities[id] = CreditFacility({
            borrower: borrower, agentBank: msg.sender, facilityType: facilityType,
            totalCommitmentUSD: commitment, outstandingDrawUSD: FHE.asEuint64(0),
            availableUSD: commitment, spreadBps: spread, commitmentFeeBps: commitFee,
            covenantScore: FHE.asEuint8(100), covenantStatus: CovenantStatus.Compliant,
