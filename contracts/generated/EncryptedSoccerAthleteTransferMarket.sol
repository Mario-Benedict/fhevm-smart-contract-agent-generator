...
contract EncryptedSportsAthleteTransferFee is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerPlayer(
        ...
        players[playerId] = PlayerContract({
            playerName: name,
            ...
            weeklySalaryEUR: salary,
            releaseClauses: release,
            contractEndYear: contEnd,
            performanceRating: rating,
            injuryHistory: FHE.asEuint8(0),
    ...
    function negotiateTransfer(
        ...
        dealId = dealCount++;
        deals[dealId] = TransferDeal({
            playerId: playerId,
            sellingClub: players[playerId].currentClub,
            buyingClub: buyingClub,
            playerAgent: agent,
            transferType: tType,
            transferFeeEUR: fee,
            agentFeeEUR: agentFee,
            signingBonusEUR: bonus,
            performanceAddons: addons,
            sellOnClausePct: sellOn,
            loanFeeMonthlyEUR: FHE.asEuint64(0),
