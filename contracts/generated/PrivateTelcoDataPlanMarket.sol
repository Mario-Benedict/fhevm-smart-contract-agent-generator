...
contract PrivateTelcoDataPlanMarket is ZamaEthereumConfig, Ownable {
    ...
    function listPlan(
        ...
        id = planCount++;
        plans[id] = DataPlan({
            planName: name, planType: planType, operator_: operator_,
            dataAllowanceMB: data, monthlyPriceUSD: price, speedMbps: speed,
            bonusDataMB: bonus, totalRevenue: FHE.asEuint64(0),
            launchedAt: block.timestamp, active: true
        });
