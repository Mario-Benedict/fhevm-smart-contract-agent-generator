...
contract PrivateTruffleHarvestAuction is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createLot(
        ...
        id = lotCount++;
        lots[id] = HarvestLot({
            producer: msg.sender, species: species, gradeClass: gradeClass,
            regionRef: regionRef, harvestYear: harvestYear, netWeightGrams: weight,
            reservePricePerKgUSD: reserve, aromaScoreBps: aroma, moistureContentBps: moisture,
            totalLotValueUSD: lotValue, auctionClosed: false
        });
