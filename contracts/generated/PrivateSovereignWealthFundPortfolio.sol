...
contract PrivateSovereignWealthFundPortfolio is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function createPortfolio(
        ...
        id = portfolioCount++;
        portfolios[id] = PortfolioAllocation({
            fundName: fundName, sovereignEntity: sovereignEntity, govType: govType,
            totalAUMUSD: aum, publicEquityUSD: FHE.asEuint64(0), fixedIncomeUSD: FHE.asEuint64(0),
            alternativesUSD: FHE.asEuint64(0), infrastructureUSD: FHE.asEuint64(0),
            realEstateUSD: FHE.asEuint64(0), cashReserveUSD: cashReserve,
            annualReturnBps: annReturn, benchmarkOutperformBps: FHE.asEuint16(0),
    ...
    function commitCoInvestment(
        ...
        dealId = dealCount++;
        deals[dealId] = CoInvestmentDeal({
            portfolioId: portfolioId, coInvestor: coInvestor, dealRef: dealRef,
            assetClass: assetClass, dealValueUSD: dealValue, swfShareBps: swfShare,
            coInvestorShareBps: coShare, expectedIRRBps: irr, committedAt: block.timestamp
        });
