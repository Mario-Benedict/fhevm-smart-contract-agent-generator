...
contract ArtworkBlindAuction is ZamaEthereumConfig, Ownable {
    ...
    function submitBid(uint256 auctionId, externalEuint64 calldata encBid, bytes calldata inputProof) external {
        ArtAuction storage a = auctions[auctionId];
        ...
        euint64 prevHigh = a.highestBid;
        a.highestBid = FHE.select(higher, bid, prevHigh);
        FHE.allowThis(a.highestBid);
    ...
    function finalizeAuction(uint256 auctionId) external onlyOwner {
        ...
        FHE.allow(a.highestBid, a.highestBidder);
