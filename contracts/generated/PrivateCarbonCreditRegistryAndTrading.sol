...
contract PrivateCarbonCreditRegistryAndTrading is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerProject(
        ...
        projects[id] = CarbonProject({
            projectDeveloper: msg.sender, projectType: projectType, standard: standard,
            projectRef: projectRef, country: country, baselineTonsCO2: baseline,
            creditsIssued: FHE.asEuint64(0), creditsRetired: FHE.asEuint64(0),
            pricePerCreditUSD: price, additionalityScore: FHE.asEuint16(0),
            verified: false, vintageYear: vintageYear
        });
