...
contract PrivateCollaborativeResearchGrant is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createGrant(
        ...
        id = grantCount++;
        grants[id] = Grant({
            grantNumber: grantNumber, researchArea: area,
            totalBudgetUSD: budget, allocatedUSD: FHE.asEuint64(0),
            disbursedUSD: FHE.asEuint64(0), overheadPoolUSD: FHE.asEuint64(0),
            startDate: startDate, endDate: endDate, active: true
        });
