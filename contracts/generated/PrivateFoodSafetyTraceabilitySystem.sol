...
contract PrivateFoodSafetyTraceabilitySystem is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerBatch(
        ...
        batches[id] = FoodBatch({
            producer: msg.sender, category: category, batchRef: batchRef, countryOfOrigin: countryOfOrigin,
            contaminationRiskScore: FHE.asEuint8(0), coldChainBreachCount: FHE.asEuint8(0),
            temperatureDeviationBps: FHE.asEuint16(0), batchWeightKg: weight,
            estimatedValueUSD: value, supplierAuditScore: auditScore,
            status: ComplianceStatus.Compliant, producedAt: block.timestamp,
