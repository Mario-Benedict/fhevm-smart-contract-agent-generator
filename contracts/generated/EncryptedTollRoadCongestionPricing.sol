...
contract EncryptedTollRoadCongestionPricing is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerGantry(
        ...
        id = gantryCount++;
        gantries[id] = TollGantry({
            gantryId: gantryId, highwaySection: section,
            vehiclesPerHour: FHE.asEuint32(0), congestionIndexBps: FHE.asEuint32(0),
            baseRateCentsPerKm: baseRate, currentRateCentsPerKm: baseRate,
            totalRevenueCollected: FHE.asEuint64(0),
            lastUpdateTimestamp: block.timestamp, status: PricingStatus.Normal
        });
