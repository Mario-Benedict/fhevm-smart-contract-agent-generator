...
contract PrivatePeerToPeerLending is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function requestLoan(
        ...
        loanRequests[id] = LoanRequest({
            borrower: msg.sender, requestedAmount: amount, maxInterestRateBps: maxRate,
            fundedAmount: FHE.asEuint64(0), fundedRateBps: FHE.asEuint64(0), repaidAmount: FHE.asEuint64(0),
            termMonths: termMonths, listedAt: block.timestamp, fundedAt: 0,
            state: LoanState.Listed, primaryLender: address(0)
        });
