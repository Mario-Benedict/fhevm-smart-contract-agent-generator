...
contract PrivateNeonatalIntensiveCareAllocation is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function admitPatient(
        ...
        admissions[admId] = PatientAdmission({
            anonymizedPatientId: anonId,
            acuityScore: acuity,
            gestationalAgeWeeks: gest,
            birthWeightGrams: weight,
            estimatedCostUSD: cost,
            lengthOfStayHours: los,
            admissionTimestamp: block.timestamp,
            acuityLevel: level,
            discharged: false,
            insurancePreauthRequired: level == AcuityLevel.LEVEL1_CRITICAL
        });
