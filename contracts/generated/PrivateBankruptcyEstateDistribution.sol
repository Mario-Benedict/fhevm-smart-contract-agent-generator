...
contract PrivateBankruptcyEstateDistribution is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function fileClaim(
        ...
        claimId = claimCount++;
        claims[claimId] = CreditorClaim({
            estateId: estateId, creditor: msg.sender, priority: priority,
            claimAmountUSD: claimAmt, allowedAmountUSD: FHE.asEuint64(0),
            distributionReceivedUSD: FHE.asEuint64(0), preferenceClawbackUSD: FHE.asEuint64(0),
