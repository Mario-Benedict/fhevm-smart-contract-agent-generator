...
contract PrivateGeothermalEnergyRoyaltyV2 is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerField(
        ...
        id = fieldCount++;
        fields[id] = GeothermalField({
            developer: msg.sender, fieldType: fieldType, fieldRef: fieldRef, country: country,
            installedCapacityMW: cap, annualOutputMWh: annOutput, royaltyRatePerkWh: royaltyRate,
            govRevenueShareBps: govShare, totalRoyaltiesAccruedUSD: FHE.asEuint64(0),
            ppaRatePerMWhUSD: ppaRate, active: true
        });
