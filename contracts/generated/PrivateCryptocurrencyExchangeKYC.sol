...
contract PrivateCryptocurrencyExchangeKYC is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function approveKYC(
        ...
        kycRecords[user] = UserKYC({
            user: user, tier: tier, riskCategory: risk,
            kycScore: kycScore, amlScore: amlScore, dailyWithdrawalLimit: dailyLimit,
            totalVolumeUSD: FHE.asEuint64(0), largestSingleTxUSD: FHE.asEuint64(0),
            kycValidUntil: block.timestamp + validDays * 1 days,
