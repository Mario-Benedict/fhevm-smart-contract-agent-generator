...
contract PrivateGamingGuildTreasuryManagement is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function addMember(
        ...
        members[member] = GuildMember({
            username: username, primaryGame: game, role: role,
            totalEarningsUSD: FHE.asEuint64(0), weeklyEarningsUSD: FHE.asEuint64(0),
            scholarShareBps: scholarShare, managerShareBps: managerShare,
            guildPoints: FHE.asEuint32(0), performanceScore: FHE.asEuint8(50),
            activityScore: FHE.asEuint8(0), active: true
        });
        ...
        FHE.allow(members[member].totalEarningsUSD, member);
