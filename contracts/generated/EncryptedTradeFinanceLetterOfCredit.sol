...
contract EncryptedTradeFinanceLetterOfCredit is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function issueLC(
        ...
        lcs[id] = LetterOfCredit({
            issuingBank: msg.sender, applicant: applicant, beneficiary: beneficiary,
            lcType: lcType, commodityDescription: commodity, incoterms: incoterms,
            creditAmountUSD: amount, drawnAmountUSD: FHE.asEuint64(0),
            availableAmountUSD: amount, documentScore: FHE.asEuint32(0),
