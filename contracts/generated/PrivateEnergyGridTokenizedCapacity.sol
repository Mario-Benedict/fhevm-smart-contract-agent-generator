...
contract PrivateEnergyGridTokenizedCapacity is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerNode(
        ...
        id = nodeCount++;
        nodes[id] = GridNode({
            operator: msg.sender, source: source, zone: zone, nodeRef: nodeRef,
            installedCapacityMW: capacity, availableCapacityMW: capacity,
            recValueUSD: recValue, curtailmentPenaltyUSD: FHE.asEuint64(0),
            demandResponsePayUSD: FHE.asEuint64(0), capacityFactorBps: capFactor, active: true
        });
