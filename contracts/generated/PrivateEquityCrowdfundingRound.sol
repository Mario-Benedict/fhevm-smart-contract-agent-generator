...
contract PrivateEquityCrowdfundingRound is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createRound(
        ...
        id = roundCount++;
        rounds[id] = FundingRound({
            company: msg.sender, roundName: roundName, instrument: instrument,
            valuationCapUSD: valCap, discountRateBps: discount, minInvestmentUSD: minInv,
            maxRaisedUSD: maxRaise, totalRaisedUSD: FHE.asEuint64(0),
            investorCount: FHE.asEuint64(0), status: RoundStatus.Open,
