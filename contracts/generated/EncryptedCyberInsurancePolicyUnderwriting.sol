...
contract EncryptedCyberInsurancePolicyUnderwriting is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function submitRiskProfile(
        ...
        riskProfiles[profileId] = CyberRiskProfile({
            industry: industry,
            annualRevenue: revenue,
            recordsStored: records,
            cyberMaturityScore: cyberMaturity,
            endpointProtectionScore: FHE.asEuint64(0),
            mfaAdoptionRate: mfaRate,
            patchingVelocityScore: patchingScore,
            backupRecoveryScore: backupScore,
            thirdPartyRiskScore: FHE.asEuint64(0),
            priorBreachLossAmount: priorLoss,
            priorBreachCount: breachCount,
            lastAssessmentDate: block.timestamp,
            mspManaged: mspManaged
        });
    ...
    function quotePolicy(
        ...
        policies[policyId] = CyberPolicy({
            ...
            sublimitRansomware: ransomSublimit,
            sublimitBEC: becSublimit,
            sublimitBI: biSublimit,
            retroactivePremiumAdjust: FHE.asEuint64(0),
            earnedPremium: FHE.asEuint64(0),
            inceptionDate: inceptionDate,
            expiryDate: expiryDate,
            coInsurance: coInsurance,
            coInsurancePercent: coPercent
        });
    ...
    function reportClaim(
        ...
        claims[claimId] = Claim({
            ...
            reservedAmount: netClaim,
            paidAmount: FHE.asEuint64(0),
            subrogationRecovered: FHE.asEuint64(0),
            publicRelationsCosts: prCost,
            forensicsCosts: forensicsCost,
            incidentDate: incidentDate,
            reportedDate: block.timestamp,
            litigationInvolved: litigationInvolved,
