...
contract PrivateCreditDefaultSwapVault is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function executeCDS(
        ...
        cdsId = cdsCount++;
        cdsContracts[cdsId] = CDSContract({
            referenceEntity: entity,
            protectionBuyer: buyer,
            protectionSeller: seller,
            rating: rating,
            notionalUSD: notional,
            spreadBps: spread,
            quarterlyPremiumUSD: quarterly,
            totalPremiumsPaid: FHE.asEuint64(0),
            recoveryRateBps: recovery,
            potentialPayoutUSD: payout,
            tenorMonths: tenor,
            inceptionDate: block.timestamp,
            maturityDate: block.timestamp + 30 days * 12,
            creditEventOccurred: false,
            settled: false,
            active: true
        });
