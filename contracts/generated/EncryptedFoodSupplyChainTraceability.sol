...
contract EncryptedFoodSupplyChainTraceability is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerBatch(
        ...
        batchNum = batchCount++;
        batches[batchNum] = ProductBatch({
            batchId: batchId, category: category, producer: msg.sender,
            farmGatePrice: farmPrice, processingCost: FHE.asEuint64(0),
            distributionCost: FHE.asEuint64(0), retailPriceUSD: FHE.asEuint64(0),
            totalMarginUSD: FHE.asEuint64(0), qualityGrade: grade,
            quantityKg: qty, co2FootprintKg: co2,
            harvestDate: harvestDate, expiryDate: expiryDate, recalled: false
        });
