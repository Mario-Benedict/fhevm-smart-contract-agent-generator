...
contract EncryptedTimberHarvestLicensing is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function grantLicense(
        ...
        id = licenseCount++;
        licenses[id] = TimberLicense({
            licensee: licensee, forestId: forestId, jurisdictionCode: jurisdiction,
            primarySpecies: species, method: method,
            authorizedVolumeBF: volume, harvestedVolumeBF: FHE.asEuint64(0),
            stumpageFeePerMBF: stumpage, totalFeesAccruedUSD: FHE.asEuint64(0),
            sustainableYieldRatioBps: yield,
            harvestSeason: block.timestamp + seasonDays * 1 days,
