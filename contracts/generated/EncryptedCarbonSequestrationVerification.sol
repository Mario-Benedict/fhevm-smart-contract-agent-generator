...
contract EncryptedCarbonSequestrationVerification is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerProject(
        ...
        projects[id] = CarbonProject({
            projectId: projectId, projectType: ptype, standard: standard,
            projectDeveloper: msg.sender, verifiedTonnesCO2: FHE.asEuint64(0),
            permanenceScore: permanence, additionalityScore: additionality,
            cobenefitsScore: coBenefits, pricePerTonnUSD: price,
            availableCredits: FHE.asEuint64(0), vintageYear: vintage, verified: false, active: true
        });
    ...
    function purchaseCredits(
        ...
        proj.availableCredits = FHE.sub(proj.availableCredits, actual);
