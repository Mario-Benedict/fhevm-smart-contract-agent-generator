...
contract PrivateDutchAuctionDecreasingPrice is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createDutchAuction(
        ...
        auctions[id] = DutchAuction({
            seller: msg.sender, assetDescription: assetDescription, startingPriceUSD: startPrice,
            floorPriceUSD: floor, currentPriceUSD: startPrice, decrementPerHourUSD: decrement,
            clearedPriceUSD: FHE.asEuint64(0), winner: address(0),
            startTime: block.timestamp, endTime: block.timestamp + durationHours * 1 hours, cleared: false
        });
