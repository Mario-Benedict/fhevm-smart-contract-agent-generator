...
contract PrivateFashionBrandLicensing is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createLicense(
        ...
        id = licenseCount++;
        licenses[id] = FashionLicense({
            brandOwner: msg.sender, licensee: licensee, brandName: brandName,
            category: category, territory: territory,
            minimumGuaranteeUSD: minGuarantee, royaltyRateBps: royaltyRate,
            netSalesReportedUSD: FHE.asEuint64(0), royaltiesPaidUSD: FHE.asEuint64(0),
            auditAdjustmentUSD: FHE.asEuint64(0), qualityScorePoints: FHE.asEuint16(10000),
            status: LicenseStatus.Active, startDate: block.timestamp,
