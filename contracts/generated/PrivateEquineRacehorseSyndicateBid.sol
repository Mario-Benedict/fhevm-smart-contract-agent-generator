...
contract PrivateEquineRacehorseSyndicateBid is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function formSyndicate(
        ...
        syndicates[syndicateId] = HorseSyndicate({
            horseNameHash: horseNameHash,
            grade: grade,
            status: SyndicateStatus.FORMATION,
            purchasePriceUSD: purchasePrice,
            totalSharesIssued: totalShares,
            shareValueUSD: shareValue,
            totalPrizeMoney: FHE.asEuint64(0),
            totalExpenses: FHE.asEuint64(0),
            netProfitLoss: FHE.asEuint64(0),
            breedingRightsValue: breedingRightsValue,
            insurancePolicyValue: insuranceValue,
            reserveFund: FHE.asEuint64(0),
