...
contract EncryptedPrivateBankWealth is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createMandate(
        ...
        mandates[mandateId] = ClientMandate({
            client: client, mandateType: mType, riskProfile: rProfile,
            aumUSD: aum, annualFeeUSD: fee, performanceFeeUSD: FHE.asEuint64(0),
            ytdReturnBps: FHE.asEuint64(0), benchmarkReturnBps: FHE.asEuint64(0),
            alphaGeneratedBps: FHE.asEuint64(0), clientSince: FHE.asEuint32(0),
            riskToleranceScore: risk, active: true, taxOptimized: false
        });
