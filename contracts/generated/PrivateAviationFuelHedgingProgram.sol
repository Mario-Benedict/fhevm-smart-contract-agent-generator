...
contract PrivateAviationFuelHedgingProgram is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function tradeHedge(
        ...
        id = hedgeCount++;
        hedges[id] = FuelHedge({
            airline: msg.sender, counterparty: counterparty, instrument: instrument,
            fuelGrade: fuelGrade, tradeRef: tradeRef, notionalGallons: notional,
            strikePrice_USDgal: strike, optionPremiumUSD: premium, currentSpotUSD: FHE.asEuint64(0),
            markToMarketUSD: FHE.asEuint64(0), settlementPayoutUSD: FHE.asEuint64(0),
            hedgeRatioBps: hedgeRatio, settled: false,
