...
contract PrivateShipBunkerFuelHedging is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerVessel(
        ...
        FHE.allow(vessels[id].totalFuelBudgetUSD, msg.sender);
    ...
    function openHedge(
        ...
        hedgeId = hedgeCount++;
        hedges[hedgeId] = BunkerHedge({
            vesselId: vesselId, grade: grade, hedgedTonnes: hedgedTonnes,
            strikePrice: strike, marketPrice: FHE.asEuint64(0), markToMarketPnL: FHE.asEuint64(0),
            premiumPaidUSD: premium, expiryDate: expiry, settled: false, exercised: false
        });
