...
contract EncryptedPrivateEquityPortfolioValuation is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function addPortfolioCompany(
        ...
        companies[companyId] = PortfolioCompany({
            companyName: name, industry: industry, stage: stage,
            leadInvestor: msg.sender, investmentCostUSD: cost,
            currentFMVUSD: fmv, revenueAnnualUSD: revenue, ebitdaUSD: ebitda,
            evMultipleBps: FHE.asEuint64(0), ownershipPctBps: ownership,
            moicBps: moic, irrPct: irr, investmentDate: block.timestamp,
            exitType: ExitType.STRATEGIC_SALE, exited: false
        });
        ...
        FHE.allow(companies[companyId].investmentCostUSD, msg.sender);
