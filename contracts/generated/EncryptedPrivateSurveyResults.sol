...
contract EncryptedPrivateSurveyResults is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createSurvey(
        ...
        id = surveyCount++;
        surveys[id] = Survey({
            creator: msg.sender, title: title, surveyRef: surveyRef, questionCount: questionCount,
            rewardPerResponseUSD: reward, totalBudgetUSD: budget, spentBudgetUSD: FHE.asEuint64(0),
            responseCount: FHE.asEuint32(0), aggregateScoreSum: FHE.asEuint64(0),
            deadline: block.timestamp + durationDays * 1 days, active: true
        });
        FHE.allowThis(surveys[id].rewardPerResponseUSD); FHE.allow(surveys[id].rewardPerResponseUSD, msg.sender);
    ...
    function submitResponse(
        ...
        responses[respId] = SurveyResponse({
            respondent: msg.sender, surveyId: surveyId, q1Response: q1, q2Response: q2,
            q3Response: q3, q4Response: q4, netPromoterScore: nps, rewardEarned: reward,
