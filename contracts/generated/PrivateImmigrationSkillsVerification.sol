...
contract PrivateImmigrationSkillsVerification is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function submitApplication(
        ...
        applications[applicantHash] = VisaApplication({
            applicantHash: applicantHash, visaCategory: visaCategory,
            languageScore: lang, educationPoints: edu,
            experiencePoints: exp, agePoints: age,
            totalPointsScore: total, salaryOfferedUSD: salary,
            adaptabilityScore: FHE.asEuint8(0),
            approved: false, processed: false, submittedAt: block.timestamp
        });
