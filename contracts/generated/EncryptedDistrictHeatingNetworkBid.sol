...
contract EncryptedDistrictHeatingNetworkBid is ZamaEthereumConfig, AccessControl, ReentrancyGuard {
    ...
    function registerProducer(
        ...
        producers[msg.sender] = HeatProducer({
            source: source,
            installedCapacityMW: capacity,
            maxAnnualOutputMWh: maxAnnual,
            variableCostPerMWh: variableCost,
            fixedCostPerYear: fixedCost,
            gridConnectionFee: connectionFee,
            currentOutputMW: FHE.asEuint64(0),
            revenueAccrued: FHE.asEuint64(0),
            carbonCreditEarned: FHE.asEuint64(0),
    ...
    function registerConsumer(
        ...
        consumers[msg.sender] = HeatConsumer({
            connectionType: connectionType,
            peakDemandMW: peakDemand,
            annualConsumptionMWh: annualConsumption,
            currentDemandMW: FHE.asEuint64(0),
            monthlyBill: FHE.asEuint64(0),
            priceCapPerMWh: priceCap,
            totalBilledToDate: FHE.asEuint64(0),
            demandResponseFlexibility: drFlexibility,
    ...
    function createSupplyAgreement(
        ...
        agreements[agreementId] = SupplyAgreement({
            producer: producer,
            consumer: consumer,
            contractedCapacityMW: contractedCapacity,
            agreedPricePerMWh: effectivePrice,
            deliveredMWh: FHE.asEuint64(0),
            billedAmount: FHE.asEuint64(0),
            startDate: startDate,
            endDate: endDate,
            active: true
        });
