...
contract PrivateFreelancerEscrow is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createJob(
        ...
        id = jobCount++;
        jobs[id] = Job({
            client: msg.sender, freelancer: freelancer,
            totalBudget: budget, amountReleased: FHE.asEuint64(0),
            disputeArbitratorFee: arbFee, milestoneCount: milestoneCount,
            completedMilestones: 0, deadline: block.timestamp + deadlineDays * 1 days,
