...
contract EncryptedAthleteSponsorshipToken is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerAthlete(
        ...
        athletes[id] = AthleteProfile({
            athleteWallet: msg.sender, sport: sport, athleteRef: athleteRef, baseContractValueUSD: baseContract,
            performanceBonusUSD: FHE.asEuint64(0), endorsementRevenueUSD: FHE.asEuint64(0),
            brandExclusivityScore: FHE.asEuint64(0), socialFollowersM: socialFollowers,
            performanceRating: performance, active: true
        });
    ...
    function signSponsorshipDeal(
        ...
        deals[dealId] = SponsorshipDeal({
            athleteId: athleteId, sponsor: msg.sender, brandRef: brandRef, dealValueUSD: dealValue,
            revenueShareBps: revShare, earningsToAthlete: athleteEarnings, dealDate: block.timestamp,
            termMonths: termMonths, exclusive: exclusive
        });
