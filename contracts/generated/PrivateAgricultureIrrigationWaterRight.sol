...
contract PrivateAgricultureIrrigationWaterRight is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerWaterRight(
        ...
        waterRights[id] = WaterRight({
            rightHolder: msg.sender, waterSource: waterSource, rightType: rightType,
            basinCode: basinCode, annualAllocationML: allocation,
            usedVolumeML: FHE.asEuint64(0), tradableVolumeML: allocation,
            priorityScore: priority, marketValuePerMLUSD: marketVal, active: true
        });
    ...
    function initiateWaterTrade(
        ...
        trades[tradeId] = WaterTrade({
            sellerRightId: sellerRightId, buyerRightId: buyerRightId,
            seller: msg.sender, buyer: buyer, volumeML: tradedVol,
            pricePerMLUSD: pricePerML, totalConsiderationUSD: totalConsideration,
