...
contract EncryptedMunicipalBondIssuance is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function announceBond(
        ...
        bonds[id] = MunicipalBond({
            issuerName: issuerName, purpose: purpose, cusip: cusip,
            faceValueUSD: faceValue, couponRateBps: coupon,
            yieldToMaturityBps: FHE.asEuint64(0),
            totalOrdersUSD: FHE.asEuint64(0), totalAllocatedUSD: FHE.asEuint64(0),
            maturityDate: block.timestamp + maturityDays * 1 days,
            settlementDate: 0, status: BondStatus.Announced, issuer: issuer
        });
