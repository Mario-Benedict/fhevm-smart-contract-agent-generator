...
contract PrivateMicrofinanceVillageBank is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerGroup(string calldata name, string calldata village) external returns (uint256 id) {
        ...
        id = groupCount++;
        groups[id] = VillageGroup({
            groupName: name, village: village,
            groupSavingsPool: FHE.asEuint64(0), loanFundUSD: FHE.asEuint64(0),
            groupCreditScore: FHE.asEuint64(500), defaultRateBps: FHE.asEuint64(0),
            interestEarnedUSD: FHE.asEuint64(0), memberCount: 0, active: true
        });
    ...
    function requestLoan(
        ...
        loans[loanId] = LoanRequest({
            ...
            requestedAmountUSD: amount, approvedAmountUSD: FHE.asEuint64(0),
            weeklyRepaymentUSD: weeklyRepayment, interestRateBps: interestRate,
            repaidSoFarUSD: FHE.asEuint64(0), termWeeks: termWeeks,
            issuedAt: 0, approved: false, repaid: false, defaulted: false
        });
