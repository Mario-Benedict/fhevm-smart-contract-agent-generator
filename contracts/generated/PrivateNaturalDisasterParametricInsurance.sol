...
contract PrivateNaturalDisasterParametricInsurance is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function bindPolicy(
        ...
        policies[policyId] = ParametricPolicy({
            insured: insured,
            insurer: msg.sender,
            disasterType: dtype,
            ...
            exhaustionThreshold: exhaust,
            accruedPremium: FHE.asEuint64(0),
            totalClaimsPaid: FHE.asEuint64(0),
        ...
        FHE.allow(policies[policyId].coverageAmountUSD, insured);
