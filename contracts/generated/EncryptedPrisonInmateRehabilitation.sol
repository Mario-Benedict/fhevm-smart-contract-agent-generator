...
contract EncryptedPrisonInmateRehabilitation is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function admitInmate(
        ...
        inmates[inmateId] = InmateRecord({
            anonymizedInmateId: FHE.asEuint16(uint16(inmateId + 50000)),
            riskScore: risk,
            programParticipation: FHE.asEuint8(0),
            behaviorScore: behavior,
            educationProgress: FHE.asEuint8(0),
            employabilityScore: FHE.asEuint8(0),
            daysServed: FHE.asEuint32(0),
            goodTimeCredits: FHE.asEuint32(0),
