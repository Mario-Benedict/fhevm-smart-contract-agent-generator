...
contract EncryptedWaterRightsTrading is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function grantRight(
        ...
        rights[id] = WaterRight({
            holder: holder, waterUse: waterUse, basinId: basinId,
            allocationMegaLiters: allocation, usedMegaLiters: FHE.asEuint64(0),
            askingPriceCentsPerML: FHE.asEuint64(0), totalValueUSD: FHE.asEuint64(0),
            validUntil: block.timestamp + validYears * 365 days,
        ...
        FHE.allow(rights[id].allocationMegaLiters, holder);
