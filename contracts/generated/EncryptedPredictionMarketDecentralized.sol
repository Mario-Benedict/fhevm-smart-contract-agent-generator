...
contract EncryptedPredictionMarketDecentralized is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createMarket(
        ...
        markets[id] = PredictionMarket({
            ...
            totalYesStake: FHE.asEuint64(0), totalNoStake: FHE.asEuint64(0),
            liquidityPool: liquidity, yesProb: FHE.asEuint64(5000),
            marketMakerSpread: spread, creatorFeePool: FHE.asEuint64(0),
            resolutionDate: resolutionDate, outcome: MarketOutcome.INVALID,
            status: MarketStatus.OPEN, creator: msg.sender
        });
