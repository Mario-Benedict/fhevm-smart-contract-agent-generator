...
contract PrivateHedgeFundStrategyVault is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function addStrategy(
        ...
        id = strategyCount++;
        strategies[id] = SubStrategy({
            strategyType: strategyType, strategyRef: strategyRef, allocatedCapitalUSD: allocation,
            currentNAVUSD: allocation, maxDrawdownBps: FHE.asEuint64(0), sharpRatioX100: sharpRatio,
            performanceFeeBps: perfFee, highWaterMarkUSD: allocation,
            performanceFeesAccruedUSD: FHE.asEuint64(0), active: true
        });
