...
contract PrivateCrowdfundedSolarFarmCooperative is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function createProject(
        ...
        id = projectCount++;
        projects[id] = SolarProject({
            projectName: projectName, location: location, projectManager: msg.sender,
            targetFundingUSD: targetFunding, raisedFundingUSD: FHE.asEuint64(0),
            installedCapacityKW: capacity, annualOutputKWh: FHE.asEuint64(0),
            totalDividendsPaidUSD: FHE.asEuint64(0), capacityFactorBps: capFactor,
            status: ProjectStatus.Crowdfunding, fundingDeadline: block.timestamp + fundingDeadlineDays * 1 days
        });
