...
contract PrivateHotelRevenueManagement is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createBooking(
        ...
        bookings[bookingId] = Booking({
            guest: msg.sender, category: category, rateChargedUSD: rate,
            totalChargeUSD: totalCharge, depositPaidUSD: deposit,
            checkInDate: checkInTimestamp,
            checkOutDate: checkInTimestamp + nightsStay * 1 days,
            nightsStay: nightsStay, status: BookingStatus.Confirmed,
