...
contract EncryptedZeroKnowledgeAgeGating is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function issueAgeCredential(
        ...
        credentials[subject] = AgeCredential({
            subject: subject, birthYearHash: birthHash, verifiedAgeOver18: over18,
            verifiedAgeOver21: over21, verifiedAgeOver65: over65, jurisdictionCode: jurisdiction,
            issuer: msg.sender, issuedAt: block.timestamp,
            expiryDate: block.timestamp + validDays * 1 days, active: true
        });
        _totalVerifiedUsers = FHE.add(_totalVerifiedUsers, FHE.asEuint32(1));
