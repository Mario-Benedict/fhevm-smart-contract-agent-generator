...
contract PrivateClinicalTrialDataSharing is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerTrial(
        ...
        id = trialCount++;
        trials[id] = ClinicalTrial({
            sponsor: msg.sender, protocolId: protocolId, drugName: drugName, phase: phase,
            enrolledPatients: enrolled, efficacyScore: FHE.asEuint32(0),
            adverseEventRateBps: FHE.asEuint16(0), dataPriceUSD: price,
            totalRevenueUSD: FHE.asEuint64(0), status: DataStatus.Collecting,
            lockDate: 0
        });
