...
contract PrivateAutoLoanOrigination is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function applyForLoan(
        ...
        loanId = loanCount++;
        AutoLoan storage _s0 = loans[loanId];
        _s0.borrower = msg.sender;
        _s0.dealership = dealership;
        _s0.vehiclePriceUSD = price;
        _s0.downPaymentUSD = downPmt;
        _s0.loanAmountUSD = loanAmt;
        _s0.annualRateBps = annualRate;
        _s0.monthlyPaymentUSD = monthlyPayment;
        _s0.ltvRatio = FHE.asEuint8(0);
        _s0.creditScore = creditScore;
        _s0.monthsRemaining = FHE.asEuint64(uint64(termMonths));
        _s0.originationDate = block.timestamp;
        _s0.status = LoanStatus.Applied;
