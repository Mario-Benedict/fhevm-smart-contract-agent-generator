...
contract PrivateOceanShippingFreightExchange is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerVessel(
        ...
        vessels[vesselId] = Vessel({
            ...
            vType: vType,
            dwt: dwt,
            dailyOperatingCostUSD: opex,
            bunkerConsumptionTons: bunker,
            availableCapacityTEU: FHE.asEuint32(0),
            vesselConditionScore: cond,
            currentPort: "TBD",
            available: true
        });
        FHE.allowThis(vessels[vesselId].dwt);
        FHE.allow(vessels[vesselId].dwt, msg.sender);
    ...
    function negotiateContract(
        ...
        contracts[cId] = FreightContract({
            ...
            contractType: contractType,
            freightRateUSD: rate,
            cargoVolumeTonnes: volume,
            totalContractValue: totalVal,
            bunkerFuelCost: bunkerCost,
            portDisbursements: portCosts,
            netVoyagePnL: netPnL,
            voyageDurationDays: duration,
            loadPort: loadPort,
            dischargePort: dischargePort,
            laycanStart: laycanStart,
            laycanEnd: laycanStart + 5 days,
            executed: false,
            settled: false
        });
