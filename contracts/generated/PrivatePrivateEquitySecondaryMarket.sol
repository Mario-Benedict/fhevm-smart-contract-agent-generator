...
contract PrivatePrivateEquitySecondaryMarket is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerLPInterest(
        ...
        id = lpInterestCount++;
        lpInterests[id] = LPInterest({
            lpHolder: msg.sender, fundId: fundId, vintage: vintage, committedCapitalUSD: committed,
            calledCapitalUSD: called, navUSD: nav, distributionsReceivedUSD: FHE.asEuint64(0),
            lpSharesBps: sharesBps, transferable: true
        });
