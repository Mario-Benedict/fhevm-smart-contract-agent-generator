...
contract EncryptedLegalEscrowSettlement is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function fileDispute(
        ...
        id = disputeCount++;
        disputes[id] = LegalDispute({
            claimant: msg.sender, respondent: respondent, caseReference: caseRef,
            claimedAmountUSD: claimed, escrowedAmountUSD: escrowed,
            claimantAwardUSD: FHE.asEuint64(0), respondentAwardUSD: FHE.asEuint64(0),
            arbitratorFeeUSD: FHE.asEuint64(0),
            filedAt: block.timestamp, hearingDeadline: block.timestamp + hearingDays * 1 days,
            status: DisputeStatus.Filed, leadArbitrator: address(0), arbitratorSignatures: 0
        });
        ...
        FHE.allow(disputes[id].claimedAmountUSD, msg.sender);
