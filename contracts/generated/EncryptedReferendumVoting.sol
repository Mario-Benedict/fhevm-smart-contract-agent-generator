...
contract EncryptedReferendumVoting is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createReferendum(
        ...
        referendums[id] = Referendum({
            question: question, jurisdiction: jurisdiction,
            totalYesWeight: FHE.asEuint64(0), totalNoWeight: FHE.asEuint64(0),
            totalAbstainWeight: FHE.asEuint64(0), registeredVoterWeight: FHE.asEuint64(0),
            voterCount: 0, status: ReferendumStatus.Registration,
            registrationEnd: regEnd, votingEnd: regEnd + votingDays * 1 days
        });
    ...
    function registerVoter(
        ...
        FHE.allowThis(voters[citizen].voteWeight); FHE.allow(voters[citizen].voteWeight, citizen);
