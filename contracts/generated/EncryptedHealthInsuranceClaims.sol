...
contract EncryptedHealthInsuranceClaims is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function submitClaim(
        ...
        id = claimCount++;
        claims[id] = Claim({
            policyHolder: holder, chargedAmount: charged, allowedAmount: allowed,
            deductibleApplied: FHE.asEuint64(0), coPayAmount: FHE.asEuint64(0),
            planPaysAmount: FHE.asEuint64(0), patientOwes: FHE.asEuint64(0),
            procedureCode: procedureCode, serviceDate: serviceDate,
            adjudicated: false, paid: false
        });
