...
contract PrivateDigitalTwinAssetValuation is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerTwin(
        ...
        id = twinCount++;
        twins[id] = DigitalTwin({
            assetId: assetId, assetClass: class_, assetOwner: msg.sender,
            currentValueUSD: value, replacementCostUSD: replacement,
            operationalEfficiency: oee, failureProbabilityBps: FHE.asEuint64(0),
            maintenanceForecastUSD: FHE.asEuint64(0), insurancePremiumBps: FHE.asEuint64(0),
            lastUpdated: block.timestamp, active: true
        });
