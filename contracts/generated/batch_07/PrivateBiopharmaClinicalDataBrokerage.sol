...
contract PrivateBiopharmaClinicalDataBrokerage is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function listDataset(
        ...
        id = listingCount++;
        listings[id].dataOwner = msg.sender;
        listings[id].category = category;
        listings[id].studyCode = studyCode;
        listings[id].patientCount = patients;
        listings[id].askPriceUSD = askPrice;
        listings[id].irbComplianceScore = irbScore;
        listings[id].deidentificationLevel = deident;
        listings[id].licensingFeeUSD = licenseFee;
