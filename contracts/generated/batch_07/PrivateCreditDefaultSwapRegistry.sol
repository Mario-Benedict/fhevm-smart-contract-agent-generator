...
contract PrivateCreditDefaultSwapRegistry is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerCDS(
        ...
        id = swapCount++;
        CreditDefaultSwap storage _s0 = swaps[id];
        _s0.protectionBuyer = msg.sender;
        _s0.protectionSeller = protectionSeller;
        _s0.referenceEntity = referenceEntity;
        _s0.cdsRef = cdsRef;
        _s0.notionalAmountUSD = notional;
        _s0.spreadBps = spread;
        _s0.premiumPaidUSD = FHE.asEuint64(0);
        _s0.recoveryRateBps = recovery;
        _s0.payoutAmountUSD = FHE.asEuint64(0);
        _s0.status = CDSStatus.Active;
        _s0.tradeDate = block.timestamp;
