    ...
    ReentrancyGuard
{
    ...
    function registerDonor(
        ...
        donorId = donorCount++;
        donors[donorId].donorType = dtype;
        donors[donorId].geneticHealthScore = health;
        donors[donorId].phenotypicMatchScore = phenotype;
        donors[donorId].anonymizedDonorId = FHE.asEuint16(uint16(donorId + 10000));
        donors[donorId].compensationUSD = comp;
        donors[donorId].availableDonations = available;
        donors[donorId].successfulDonations = FHE.asEuint8(0);
        donors[donorId]._anonymous = _anonymous;
