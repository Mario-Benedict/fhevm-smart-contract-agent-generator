...
contract PrivateFoodBeverageFranchiseRoyalty is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerFranchiseUnit(
        ...
        id = unitCount++;
        FranchiseUnit storage _s0 = units[id];
        _s0.franchisee = franchisee;
        _s0.unitCode = unitCode;
        _s0.tier = tier;
        _s0.territory = territory;
        _s0.weeklyGrossSalesUSD = FHE.asEuint64(0);
        _s0.royaltyRateBps = royaltyRate;
        _s0.marketingLevyBps = levyBps;
        _s0.totalRoyaltiesPaidUSD = FHE.asEuint64(0);
        _s0.totalLevyPaidUSD = FHE.asEuint64(0);
        _s0.auditScorePoints = FHE.asEuint16(0);
        _s0.renewalStatus = RenewalStatus.Eligible;
        _s0.openedAt = block.timestamp;
