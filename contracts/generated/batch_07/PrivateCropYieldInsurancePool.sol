...
contract PrivateCropYieldInsurancePool is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function writePolicy(
        ...
        id = policyCount++;
        CropPolicy storage _s0 = policies[id];
        _s0.farmer = msg.sender;
        _s0.cropType = cropType;
        _s0.product = product;
        _s0.countyFIPS = countyFIPS;
        _s0.insuredAcres = acres;
        _s0.guaranteedYieldBusAc = guaranteedYield;
        _s0.projectedPriceUSD = projPrice;
        _s0.totalLiabilityUSD = totalLiability;
        _s0.premiumPaidUSD = premium;
        _s0.coverageLevelBps = covLevel;
        _s0.indemnityPaidUSD = FHE.asEuint64(0);
        _s0.claimed = false;
