...
contract PrivateCarbonForwardMarket is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function createForward(
        ...
        forwards[id].forwardPricePerTon = price;
        forwards[id].volumeTons = volume;
        forwards[id].buyerMarginDeposit = FHE.asEuint64(0);
        forwards[id].sellerMarginDeposit = FHE.asEuint64(0);
        forwards[id].settlementAmount = FHE.asEuint64(0);
        forwards[id].maturityDate = maturity;
        forwards[id].settled = false;
        forwards[id].disputed = false;
