...
contract PrivateNuclearPowerPlantFuelContract is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function awardContract(
        ...
        euint64 total = FHE.mul(FHE.asEuint64(0), price); // placeholder, updated below
        id = contractCount++;
        contracts[id] = FuelContract({
            utility: msg.sender, supplier: supplier, fuelType: fuelType, reactorId: reactorId,
            quantityKgU: qty, enrichmentLevelBps: enrichment,
            pricePerKgUSD: price, totalContractValueUSD: FHE.asEuint64(0),
            deliveredKgU: FHE.asEuint64(0),
        ...
        FHE.allow(contracts[id].quantityKgU, supplier);
