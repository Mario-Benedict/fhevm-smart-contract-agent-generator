...
contract EncryptedCarbonCreditMarket is ZamaEthereumConfig, Ownable {
    ...
    function listProject(
        ...
        projects[id] = CarbonProject({
            projectDeveloper: msg.sender, projectName: name, location: location,
            creditType: creditType, totalCreditsIssued: credits, creditsAvailable: credits,
            verificationScore: FHE.asEuint8(0), pricePerTonneMicroUSD: price,
            vintageYear: vintageYear, verified: false, active: true
        });
    ...
    function purchaseCredits(
        ...
        p.creditsAvailable = FHE.sub(p.creditsAvailable, actual);
