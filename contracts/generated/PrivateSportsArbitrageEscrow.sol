...
contract PrivateSportsArbitrageEscrow is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function openArb(
        ...
        arbId = arbCount++;
        arbs[arbId] = ArbitrageOpportunity({
            arbTrader: msg.sender, sportType: sportType, eventRef: eventRef,
            leg1StakeUSD: stake1, leg2StakeUSD: stake2, leg1OddsBps: odds1, leg2OddsBps: odds2,
            guaranteedProfitUSD: profit, totalExposureUSD: totalExposure,
            status: ArbStatus.Open, eventDate: eventDate
        });
