...
contract PrivateShipCharterPartyAgreement is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createCharterParty(
        ...
        charterParties[cpId] = CharterParty({
            shipowner: msg.sender,
            charterer: charterer,
            charterType: charterType,
            cargoType: cargoType,
            status: CharterStatus.CONFIRMED,
            freightRate: freightRate,
            cargoQuantityMT: cargoQty,
            totalFreight: totalFreight,
            laytimeAllowedHours: laytime,
            laytimeUsedHours: FHE.asEuint64(0),
            demurrageRatePerHour: demurrageRate,
            demurrageAccrued: FHE.asEuint64(0),
            despatchEarned: FHE.asEuint64(0),
            deadweightTonnage: dwt,
            hireRatePerDay: FHE.asEuint64(0),
        ...
        FHE.allow(freightRate, msg.sender);
