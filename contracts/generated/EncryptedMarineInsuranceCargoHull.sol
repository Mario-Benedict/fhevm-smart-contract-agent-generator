...
contract EncryptedMarineInsuranceCargoHull is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function bindPolicy(
        ...
        policies[policyId] = MarinePolicy({
            assured: assured, insType: insType, vesselName: vesselName,
            voyageRoute: voyageRoute, riskCategory: riskCat,
            insuredValueUSD: insVal, annualPremiumUSD: premium,
            deductibleUSD: deduct, premiumPaidUSD: FHE.asEuint64(0),
            claimsReserveUSD: FHE.div(insVal, 20),
            routeRiskScore: rRoute, vesselConditionScore: vCond,
        ...
        FHE.allow(policies[policyId].insuredValueUSD, assured);
