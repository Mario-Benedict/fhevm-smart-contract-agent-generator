...
contract PrivateSupplyChainFinanceFactoring is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function approveBuyer(
        ...
        FHE.allow(buyers[buyer].approvedCreditLine, buyer);
    ...
    function submitInvoice(
        ...
        id = invoiceCount++;
        invoices[id] = Invoice({
            supplier: msg.sender, buyer: buyer,
            invoiceAmountUSD: amount, advanceRateBps: advanceRate,
            advanceAmountUSD: advance, discountRateBps: FHE.asEuint64(200),
            factorFeeUSD: factorFee, supplierCreditScore: creditScore,
            invoiceDueDate: dueDate, advancedAt: 0, funded: false, repaid: false, disputed: false
        });
