...
contract PrivateQuantumSafeDigitalIdentity is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerIdentity(
        ...
        identities[msg.sender] = DigitalIdentity({
            holder: msg.sender, kycTier: tier, identityScore: score,
            biometricHashA: bioA, biometricHashB: bioB, countryCode: country,
            sanctionsFlag: FHE.asEuint8(0), pepFlag: FHE.asEuint8(0),
            active: true, registeredAt: block.timestamp, lastVerifiedAt: block.timestamp
        });
