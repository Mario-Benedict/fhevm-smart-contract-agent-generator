...
contract PrivateSpaceDebrisMitigationBond is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerSatellite(
        ...
        satellites[satId] = SatelliteRegistration({
            satelliteName: name,
            noradId: noradId,
            operator: msg.sender,
            orbit: orbit,
            performanceBondUSD: bond,
            collisionProbability: collProb,
            debrisObjectsCreated: FHE.asEuint32(0),
            complianceScore: comp,
            operationalLifeYears: lifeYrs,
        ...
        FHE.allow(satellites[satId].performanceBondUSD, msg.sender);
    ...
    function submitRemovalBid(
        ...
        bidId = bidCount++;
        bids[bidId] = DebrisRemovalBid({
            debrisObjectId: debrisObjectId,
            removalCompany: msg.sender,
            bidAmountUSD: bidAmt,
            proposedCostUSD: cost,
            removalTimelineDays: timeline,
            technicalFeasibility: feasib,
