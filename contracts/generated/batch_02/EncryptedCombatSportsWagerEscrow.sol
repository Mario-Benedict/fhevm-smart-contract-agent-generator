...
contract EncryptedCombatSportsWagerEscrow is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createEvent(
        ...
        eventId = eventCount++;
        FightEvent storage _s0 = events[eventId];
        _s0.eventName = eventName;
        _s0.venue = venue;
        _s0.discipline = discipline;
        _s0.fighterId_A = fighterA;
        _s0.fighterId_B = fighterB;
        _s0.oddsA = oddsA;
        _s0.oddsB = oddsB;
        _s0.totalEscrowedA = FHE.asEuint64(0);
        _s0.totalEscrowedB = FHE.asEuint64(0);
        _s0.scheduledRounds = rounds;
        _s0.eventDate = eventDate;
        _s0.outcome = FightOutcome.PENDING;
        _s0.winMethod = WinMethod.DECISION;
        _s0.resolved = false;
