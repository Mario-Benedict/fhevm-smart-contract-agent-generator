...
contract PrivateDefenseContractBidding is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function publishRFP(
        ...
        id = rfpCount++;
        rfps[id] = DefenseRFP({
            rfpNumber: rfpNumber, category: category, minClearance: minClearance,
            estimatedValueUSD: estValue, awardedValueUSD: FHE.asEuint64(0),
            technicalWeightBps: techWeight, priceWeightBps: priceWeight,
            awardedVendor: address(0), status: AwardStatus.Open,
            proposalDeadline: block.timestamp + deadlineDays * 1 days
        });
