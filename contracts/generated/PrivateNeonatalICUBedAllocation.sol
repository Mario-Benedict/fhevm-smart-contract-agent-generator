...
contract PrivateNeonatalICUBedAllocation is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function admitPatient(
        ...
        patients[patientToken] = NeonatalPatient({
            patientToken: patientToken,
            acuityLevel: level,
            transferStatus: TransferStatus.LOCAL,
            insuranceType: insuranceType,
            gestationalAgeWeeks: gestAge,
            birthWeightGrams: birthWeight,
            acuityScore: acuityScore,
            dailyCostUSD: dailyCost,
            totalAccruedCostUSD: FHE.asEuint64(0),
            insuranceCoveredUSD: FHE.asEuint64(0),
            familyLiabilityUSD: FHE.asEuint64(0),
            transportCostUSD: FHE.asEuint64(0),
            admittedAt: block.timestamp,
            dischargedAt: 0,
            active: true,
            financialCounselingDone: false
        });
