...
contract EncryptedCybersecurityBugBounty is ZamaEthereumConfig, Ownable {
    ...
    function submitReport(
        ...
        reports[id] = BugReport({
            researcher: msg.sender, programName: progName, encryptedVulnHash: vulnHash,
            severity: severity, cvssScore: cvss, bountyAmountUSD: FHE.asEuint64(0),
            researcherEarnings: FHE.asEuint64(0), status: BugStatus.Submitted,
            submittedAt: block.timestamp, patchedAt: 0, duplicateFlag: false
        });
