...
contract PrivatePharmaSupplyChainColdChain is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function logTemperature(
        ...
        ebool tooLow = FHE.lt(temp, FHE.asEuint16(uint16(s.minTempCelsiusx10)));
        ebool tooHigh = FHE.gt(temp, FHE.asEuint16(uint16(s.maxTempCelsiusx10)));
    ...
    function transferCustody(
        ...
        FHE.allow(custodyChain[shipmentId][idx].tempAtHandoff, newCustodian);
