...
contract PrivateGeneticDataMarketplace is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function contributeDataset(
        ...
        datasets[id] = GeneticDataset({
            donor: msg.sender, category: category, consent: consent,
            snpCount: snp, ancestryDiversityScore: ancestry, qualityScore: quality,
            accessFeeUSD: fee, totalRevenueUSD: FHE.asEuint64(0),
            contributionDate: block.timestamp, active: true
        });
