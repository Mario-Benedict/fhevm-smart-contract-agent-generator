...
contract PrivateDistillerySpiritsAging is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerCask(
        ...
        id = caskCount++;
        casks[id] = AgingCask({
            distillery: msg.sender, spiritsType: spiritsType, caskRef: caskRef,
            distillationYear: distillationYear, initialVolumeLiters: initVol,
            currentVolumeLiters: initVol, abvBps: abv, currentValuationUSD: valuation,
            acquisitionCostUSD: acqCost, agingProgressMonths: FHE.asEuint16(0), bottled: false
        });
