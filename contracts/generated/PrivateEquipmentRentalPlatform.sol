...
contract PrivateEquipmentRentalPlatform is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function listEquipment(
        ...
        equipment[id] = Equipment({
            serialNumber: serial, category: cat, model: model, owner_: msg.sender,
            dailyRateUSD: daily, weeklyRateUSD: weekly, depositAmountUSD: deposit,
            utilizationRateBps: FHE.asEuint64(0), maintenanceCostUSD: FHE.asEuint64(0),
            currentValue: value, available: true
        });
    ...
    function startRental(
        ...
        rentals[rentalId] = RentalAgreement({
            equipmentId: equipmentId, renter: msg.sender,
            totalRentUSD: totalRent, depositPaid: depositPaid,
            damageCostUSD: FHE.asEuint64(0), depositRefund: FHE.asEuint64(0),
