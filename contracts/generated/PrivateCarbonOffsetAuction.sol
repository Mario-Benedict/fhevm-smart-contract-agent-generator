...
contract PrivateCarbonOffsetAuction is ZamaEthereumConfig, Ownable {
    ...
    function createLot(string calldata project, string calldata certifier, uint256 tons, uint256 vintage,
        ...
        id = lotCount++;
        lots[id] = OffsetLot({ projectName: project, certifier: certifier, tonsOfCO2: tons, vintage: vintage,
            priceFloor: floor, highestBid: FHE.asEuint64(0), highestBidder: address(0),
