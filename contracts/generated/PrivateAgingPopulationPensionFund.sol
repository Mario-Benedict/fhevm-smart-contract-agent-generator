...
contract PrivateAgingPopulationPensionFund is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createPlan(
        ...
        plans[id] = PensionPlan({
            ...
            totalAssetsUSD: assets, presentValueLiabilityUSD: liability,
            fundingRatioBps: fundingRatio, annualContributionsUSD: FHE.asEuint64(0),
            discountRateBps: discountRate, valuationDate: block.timestamp
        });
