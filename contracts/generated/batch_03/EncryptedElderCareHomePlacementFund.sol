...
contract EncryptedElderCareHomePlacementFund is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        financials.monthlyPrivateRevenue = FHE.asEuint64(0);
        financials.monthlyMedicaidRevenue = FHE.asEuint64(0);
        financials.monthlyMedicareRevenue = FHE.asEuint64(0);
        financials.totalUncompensatedCare = FHE.asEuint64(0);
        financials.medicaidPendingReceivable = FHE.asEuint64(0);
        financials.occupancyRevenueCap = FHE.asEuint64(0);
        financials.totalBeds = totalBeds;
        financials.occupiedBeds = FHE.asEuint16(0);
        financials.medicaidCertifiedBeds = medicaidBeds;
    ...
    function admitResident(
        ...
        _s0.careLevel = careLevel;
        _s0.payorType = payorType;
        _s0.status = AdmissionStatus.ADMITTED;
        _s0.monthlyPrivatePayRate = privateRate;
        _s0.monthlyMedicaidRate = medicaidRate;
        _s0.privatePaySupplement = supplement;
        _s0.assetsAtAdmission = totalAssets;
        _s0.currentAssets = totalAssets;
        _s0.spendDownTarget = spendDownTarget;
        _s0.monthlyFamilyContribution = familyContribution;
        _s0.totalBilledToDate = FHE.asEuint64(0);
        _s0.medicaidLienAmount = FHE.asEuint64(0);
        _s0.longTermCareInsuranceBenefit = ltciBenefit;
        _s0.admittedAt = block.timestamp;
        _s0.medicaidConversionDate = 0;
        _s0.medicaidEligible = false;
