...
contract EncryptedMedicalDeviceLifecycleCompliance is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerDevice(
        ...
        MedicalDevice storage _s0 = devices[deviceId];
        _s0.serialNumber = serial;
        _s0.udCode = udc;
        _s0.deviceType = devType;
        _s0.deviceClass = dClass;
        _s0.manufacturer = msg.sender;
        _s0.currentFacility = facility;
        _s0.acquisitionCostUSD = cost;
        _s0.currentValueUSD = cost;
        _s0.maintenanceCostYTD = FHE.asEuint64(0);
        _s0.revenueGeneratedUSD = FHE.asEuint64(0);
        _s0.safetyScore = safety;
        _s0.calibrationScore = calib;
        _s0.patientsServed = FHE.asEuint32(0);
        _s0.adverseEventCount = FHE.asEuint32(0);
        _s0.manufactureDate = block.timestamp;
        _s0.lastCalibrationDate = block.timestamp;
        _s0.nextCalibrationDue = nextCalibDue;
