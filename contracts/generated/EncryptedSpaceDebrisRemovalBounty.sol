...
contract EncryptedSpaceDebrisRemovalBounty is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerContractor(
        ...
        FHE.allow(contractors[contractor].capabilityScore, contractor);
    ...
    function postMission(
        ...
        id = missionCount++;
        missions[id] = DebrisMission({
            noradId: noradId, orbitRegime: orbitRegime, debrisClass: dc,
            bountyUSD: bounty, techComplexityScore: complexity, timeWindowDays: window,
            deadline: block.timestamp + 365 days,
            status: MissionStatus.Posted, assignedContractor: address(0)
        });
