...
contract TradeFinancePrivate is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function issueInvoice(
        ...
        id = nextInvoiceId++;
        invoices[id] = Invoice({
            exporter: msg.sender, importer: importer, financingBank: address(0),
            goodsDescription: goods, invoiceAmount: amount,
            discountRate: FHE.asEuint64(0), financedAmount: FHE.asEuint64(0),
