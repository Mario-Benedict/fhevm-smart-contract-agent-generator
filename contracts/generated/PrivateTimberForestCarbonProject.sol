...
contract PrivateTimberForestCarbonProject is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerProject(
        ...
        id = projectCount++;
        projects[id] = ForestProject({
            projectDeveloper: msg.sender, verifier: verifier, forestType: forestType,
            standard: standard, projectRef: projectRef, hectaresProtected: hectares,
            annualSequestrationTCO2: sequestration, bufferPoolTCO2: FHE.asEuint64(0),
            issuedCreditsTCO2: FHE.asEuint64(0), creditPriceUSD: creditPrice,
            leakageRateBps: leakage, verified: false
        });
