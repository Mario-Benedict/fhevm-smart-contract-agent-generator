...
contract EncryptedBiometricAccessControl is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerEmployee(
        ...
        euint64 composite = FHE.div(
            FHE.add(FHE.add(FHE.mul(facial, FHE.asEuint64(30)), FHE.mul(fingerprint, FHE.asEuint64(30))),
        ...
        profiles[employee] = EmployeeProfile({
            ...
            behavioralScore: behavioral, keystrokeDynamics: FHE.asEuint64(0),
            voicePrintScore: voice, compositeScore: composite,
            maxClearance: maxClearance, active: true, flagged: false
        });
