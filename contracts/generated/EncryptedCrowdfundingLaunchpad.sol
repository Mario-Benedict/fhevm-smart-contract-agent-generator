...
contract EncryptedCrowdfundingLaunchpad is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createCampaign(
        ...
        campaigns[id] = Campaign({
            projectName: name, description: description, creator: msg.sender,
            softCap: softCap, hardCap: hardCap, totalRaised: FHE.asEuint64(0),
            platformFeeBps: platFee, deadline: block.timestamp + durationDays * 1 days,
            status: CampaignStatus.Active, claimedByCreator: false
        });
