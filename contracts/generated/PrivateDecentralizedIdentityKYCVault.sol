...
contract PrivateDecentralizedIdentityKYCVault is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function issueIdentity(
        ...
        identities[holder] = Identity({
            holder: holder, tier: tier,
            creditScore: credit, amlRiskScore: aml,
            idVerificationScore: idScore, sanctionScore: FHE.asEuint8(0),
            annualIncomeUSD: income, netWorthUSD: netWorth,
            jurisdictionCode: jurisCode,
            issuedAt: block.timestamp,
            expiresAt: block.timestamp + validityDays * 1 days,
            sanctionStatus: SanctionStatus.CLEAR, active: true
        });
