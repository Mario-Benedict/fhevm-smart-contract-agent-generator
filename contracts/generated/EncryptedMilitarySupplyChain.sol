...
contract EncryptedMilitarySupplyChain is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function addDefensePart(
        ...
        id = partCount++;
        parts[id] = DefensePart({
            partNumber: partNumber, description: description, classification: classification,
            currentCustodian: msg.sender, quantityOnHand: qty, unitCostUSD: unitCost,
            totalInventoryValue: totalVal, conditionRating: condition,
            lastAuditDate: block.timestamp, active: true
        });
    ...
    function initiateTransfer(
        ...
        FHE.allow(transfers[transferId].quantity, to_);
