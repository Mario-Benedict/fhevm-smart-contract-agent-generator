...
contract PrivateUrbanDataCenterLeasing is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createLease(
        ...
        id = leaseCount++;
        leases[id] = DataCenterLease({
            landlord: msg.sender, tenant: tenant, facilityRef: facilityRef,
            tierLevel: tierLevel, powerDensity: powerDensity, cabinetCount: cabinets,
            monthlyRentUSD: monthlyRent, powerCostPerKWhUSD: powerRate, pueRatioBps: pue,
            totalCommitmentUSD: totalCommit, totalPaidUSD: FHE.asEuint64(0), carbonKgPerMonth: carbonKg,
