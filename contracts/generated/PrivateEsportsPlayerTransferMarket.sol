...
contract PrivateEsportsPlayerTransferMarket is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function listPlayer(
        ...
        players[id] = PlayerProfile({
            playerWallet: playerWallet, playerTag: playerTag, gameTitle: gameTitle,
            currentSalaryUSD: salary, marketValueUSD: value, buyoutClauseUSD: buyout,
            kpiRating: kpi, winRateBps: winRate, currentTeam: msg.sender,
