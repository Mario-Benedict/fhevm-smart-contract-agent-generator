...
contract PrivateMunicipalWaterUtilityTariff is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        tariff = TariffStructure({
            baseMonthlyCharge: baseCharge,
            tier1RatePerGallon: tier1Rate,
            tier2RatePerGallon: tier2Rate,
            tier3RatePerGallon: tier3Rate,
            tier4RatePerGallon: tier4Rate,
            sewerRatePercent: FHE.asEuint64(8000),   // 80% of water
            stormwaterChargeFlat: FHE.asEuint64(0),
            droughtSurchargePercent: FHE.asEuint64(0),
            lowIncomeDiscountBps: FHE.asEuint64(5000), // 50% LIRA discount
            currentDroughtStage: DroughtStage.NONE
        });

        systemFinancials = SystemFinancials({
            totalRevenueCollected: FHE.asEuint64(0),
            totalArrears: FHE.asEuint64(0),
            lowIncomeSubsidyPaid: FHE.asEuint64(0),
            debtServiceCoverage: FHE.asEuint64(0),
            operatingReserve: FHE.asEuint64(0),
            capitalImprovementFund: FHE.asEuint64(0),
            averageSystemRevenue: FHE.asEuint64(0)
        });
    ...
    function openAccount(
        ...
        accounts[customer] = WaterAccount({
            customerClass: customerClass,
            status: ServiceStatus.ACTIVE,
            monthlyBaselineGallons: baselineGallons,
            monthlyConsumptionGallons: FHE.asEuint64(0),
            currentMonthBill: FHE.asEuint64(0),
            totalBilledToDate: FHE.asEuint64(0),
            arrearsBalance: FHE.asEuint64(0),
            depositOnFile: deposit,
            incomeAssistanceBenefit: FHE.asEuint64(0),
            pretreatmentSurchargeDue: FHE.asEuint64(0),
            currentTier: ConservationTier.TIER_1_BASELINE,
            lowIncomeEligible: lowIncomeEligible,
            pretreatmentRequired: pretreatmentRequired,
            lastReadDate: block.timestamp
        });
        ...
        FHE.allow(accounts[customer].monthlyConsumptionGallons, customer);
