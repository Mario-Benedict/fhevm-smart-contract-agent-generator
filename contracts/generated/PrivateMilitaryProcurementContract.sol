...
contract PrivateMilitaryProcurementContract is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function issueContract(
        ...
        id = contractCount++;
        contracts[id] = DefenseContract({
            primeContractor: primeContractor, category: category,
            programName: programName, systemDesignator: designator,
            classification: classification,
            contractValueUSD: val, researchCostUSD: rd,
            productionCostPerUnit: unitCost, unitQuantity: qty,
            performanceScore: FHE.asEuint32(0), reliabilityRatingBps: FHE.asEuint32(0),
