...
contract EncryptedBiomedicalDataMarket is ZamaEthereumConfig, Ownable {
    ...
    function listDataset(
        ...
        id = datasetCount++;
        datasets[id] = Dataset({
            description: description, dataCategory: category, dataOwner: msg.sender,
            recordCount: records, accessPriceUSD: price, privacyGuarantee: privacy,
            totalRevenue: FHE.asEuint64(0), createdAt: block.timestamp, active: true
        });
        ...
        external returns (uint256 accessId)
    {
        ...
        euint64 ownerNet = FHE.sub(accepted, platformFee);
