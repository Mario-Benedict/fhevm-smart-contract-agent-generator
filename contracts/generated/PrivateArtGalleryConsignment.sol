...
contract PrivateArtGalleryConsignment is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function consignArtwork(
        ...
        id = artworkCount++;
        artworks[id] = Artwork({
            consignor: msg.sender, artistName: artist, title: title,
            yearCreated: yearCreated, medium: medium, dimensions: dimensions,
            reservePriceUSD: reserve, estimateLowUSD: estLow, estimateHighUSD: estHigh,
            hammerPriceUSD: FHE.asEuint64(0), premiumRateBps: premium,
            sellerProceedsUSD: FHE.asEuint64(0),
            status: SaleStatus.Consigned, auctionDate: auctionTimestamp
        });
