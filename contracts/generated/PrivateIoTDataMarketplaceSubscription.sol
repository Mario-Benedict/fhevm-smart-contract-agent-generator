...
contract PrivateIoTDataMarketplaceSubscription is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerDataStream(
        ...
        id = streamCount++;
        streams[id] = DataStream({
            networkOperator: msg.sender, category: category, streamId: streamId, geoRegion: geoRegion,
            pricePerMonthUSD: price, deviceCount: deviceCount, qualityScoreBps: quality,
            totalRevenueUSD: FHE.asEuint64(0), activeSubscribers: FHE.asEuint32(0), active: true
        });
