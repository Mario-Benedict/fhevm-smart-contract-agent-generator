...
contract PrivateNFTBlindAuction is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function listAuction(
        ...
        id = auctionCount++;
        auctions[id] = NFTAuction({
            seller: msg.sender, nftContract: nftContract, tokenId: tokenId,
            metadataURI: metadataURI, reservePrice: reserve,
            highestBid: FHE.asEuint64(0), highestBidder: address(0),
            startTime: block.timestamp, endTime: block.timestamp + durationHours * 1 hours, settled: false
        });
