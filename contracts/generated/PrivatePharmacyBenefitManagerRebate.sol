...
contract PrivatePharmacyBenefitManagerRebate is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function negotiateDrugContract(
        ...
        drugContracts[contractId] = DrugContract({
            ...
            listPrice: listPrice,
            netPrice: netPrice,
            guaranteedRebateBps: rebateBps,
            performanceThreshold: perfThreshold,
            marketShareTarget: marketShareTarget,
            currentMarketShare: FHE.asEuint64(0),
            annualClaimsEstimate: annualClaims,
    ...
    function recordQuarterlyAccrual(
        ...
        accruals[accrualId] = RebateAccrual({
            drugContractId: contractId,
            claimsVolume: claimsVolume,
            grossRebateAccrued: grossRebate,
            performanceBonusAccrued: perfBonus,
            marketShareAdjustment: FHE.asEuint64(0),
            netRebateDue: netRebate,
    ...
    function settleRebate(bytes32 accrualId, address planSponsor) external onlyOwner {
        ...
        if (plan.transparencyModel) {
            ...
            FHE.allow(plan.passThroughAmount, planSponsor);
        }
