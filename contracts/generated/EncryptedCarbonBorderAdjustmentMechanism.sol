...
contract EncryptedCarbonBorderAdjustmentMechanism is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function fileDeclaration(
        ...
        id = declarationCount++;
        declarations[id] = CBAMDeclaration({
            importer: msg.sender, originCountry: originCountry, sector: sector, cnCode: cnCode,
            importQuantityTonnes: qty, embeddedCarbonTonnes: embedded,
            carbonPricePaidUSD: pricePaid, cbamObligationUSD: obligation,
            certificatesRequired: embedded, declarationPeriod: period,
