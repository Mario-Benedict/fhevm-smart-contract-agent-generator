...
contract PrivateInternationalStudentLoanPool is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function addLoan(
        ...
        loans[id] = StudentLoan({
            borrower: borrower, studentId: studentId, institutionCode: institutionCode,
            principalUSD: principal, outstandingBalanceUSD: principal, interestRateBps: rate,
            repaymentScorePoints: FHE.asEuint8(100), defermentMonths: deferment,
            status: LoanStatus.Active, disbursedAt: block.timestamp,
