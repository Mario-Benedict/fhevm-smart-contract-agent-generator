...
contract EncryptedUrbanDataMonetization is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerStream(
        ...
        streams[id] = DataStream({
            streamName: name, dataType: dtype, granularity: granularity,
            sensorNetwork: sensorNetwork, dailyDataPoints: dataPoints,
            pricingTierUSD: pricing, totalRevenue: FHE.asEuint64(0),
            privacyBudgetEpsilon: epsilon, active: true, publisher: msg.sender
        });
