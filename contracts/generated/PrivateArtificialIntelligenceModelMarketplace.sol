...
contract PrivateArtificialIntelligenceModelMarketplace is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function listModel(
        ...
        models[modelId] = AIModel({
            modelName: name, modelVersion: version, modelType: mType,
            creator: msg.sender, trainingCostUSD: trainCost, benchmarkScore: benchmark,
            inferenceLatencyMs: FHE.asEuint64(0), listingPriceUSD: listPrice,
            perQueryPriceUSD: perQuery, royaltyBps: royalty,
            parametersBillions: params, totalLicenses: FHE.asEuint32(0),
            totalRevenueUSD: FHE.asEuint64(0), listed: true
        });
