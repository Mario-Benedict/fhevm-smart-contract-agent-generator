...
contract EncryptedInfrastructurePPP is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function registerProject(
        ...
        euint32 concessionPeriod = FHE.fromExternal(encYears, yProof);
        euint16 irr = FHE.fromExternal(encIRR, irrProof);
        id = projectCount++;
        projects[id] = PPPProject({
            concessionaire: msg.sender, governmentBody: governmentBody,
            ...
            concessionYears: concessionPeriod, irr_Bps: irr,
