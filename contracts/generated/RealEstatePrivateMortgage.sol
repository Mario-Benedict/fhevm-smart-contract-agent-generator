...
contract RealEstatePrivateMortgage is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function applyForMortgage(
        ...
        applications[id] = MortgageApplication({
            applicant: msg.sender,
            propertyValue: propVal, loanAmount: loanAmt,
            annualIncome: income, ltvRatioBps: ltv, dtiRatioBps: dti,
            creditScore: credit, riskGrade: FHE.asEuint8(0),
            interestRateBps: FHE.asEuint64(0),
            status: MortgageStatus.Application,
            submittedAt: block.timestamp, approvedAt: 0
        });
