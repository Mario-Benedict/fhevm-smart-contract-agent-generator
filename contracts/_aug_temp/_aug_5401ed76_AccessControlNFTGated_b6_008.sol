...
contract AccessControlNFTGated_b6_008 is ZamaEthereumConfig {
    ...
    function checkContentAccess(address prv_m, uint8 requiredGrade) public returns (ebool) {
        ebool aux_0 = verifiedHolders[prv_m];
        ebool idx_a = FHE.ge(accessGrade[prv_m], FHE.asEuint8(requiredGrade));
        ebool canAccess = FHE.and(aux_0, idx_a);
        FHE.allow(canAccess, prv_m);
