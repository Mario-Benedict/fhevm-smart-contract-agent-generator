...
contract EncryptedInternationalStudentScholarshipBidding is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createPool(
        ...
        ScholarshipPool storage _s0 = pools[poolId];
        _s0.scholarshipType = scholarshipType;
        _s0.level = level;
        _s0.totalFundingUSD = totalFunding;
        _s0.remainingFundingUSD = totalFunding;
        _s0.perAwardMinimumUSD = minAward;
        _s0.perAwardMaximumUSD = maxAward;
        _s0.maxRecipients = maxRecipients;
        _s0.awardedCount = FHE.asEuint32(0);
        _s0.nationalityQuotaSlots = natQuota;
        _s0.applicationDeadline = applicationDeadline;
        _s0.awardDate = awardDate;
        _s0.active = true;
    ...
    function submitApplication(
        ...
        Application storage _s1 = applications[applicationId];
        _s1.poolId = poolId;
        _s1.applicant = msg.sender;
        _s1.status = ApplicationStatus.SUBMITTED;
        _s1.requestedAmountUSD = clampedAmount;
        _s1.awardedAmountUSD = FHE.asEuint64(0);
        _s1.financialNeedScore = financialNeed;
        _s1.academicMeritScore = academicMerit;
        _s1.researchScore = researchScore;
        _s1.committeeRankScore = FHE.asEuint64(0);
        _s1.nationalityQuotaUsed = FHE.asEuint64(0);
        _s1.countryCode = countryCode;
        _s1.submittedAt = block.timestamp;
        _s1.financialVerified = false;
        _s1.academicVerified = false;
    ...
    function awardScholarship(bytes32 applicationId) external onlyOwner nonReentrant {
        ...
        FHE.allowThis(_totalScholarshipsAwarded);
        FHE.allowThis(_totalApplicantsServed);
        FHE.allow(actualAward, app.applicant); // [acl_misconfig]
        FHE.allow(_totalScholarshipsAwarded, msg.sender); // [acl_misconfig]
        FHE.allow(_totalApplicantsServed, msg.sender); // [acl_misconfig]
