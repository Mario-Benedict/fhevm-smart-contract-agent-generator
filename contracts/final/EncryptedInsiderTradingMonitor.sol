...
contract EncryptedInsiderTradingMonitor is ZamaEthereumConfig, Ownable {
    ...
    function reportTrade(
        ...
        tradeReports[reportId].insider = msg.sender;
        tradeReports[reportId].direction = direction;
        tradeReports[reportId].tradeValueUSD = tradeValue;
        tradeReports[reportId].positionAfterUSD = posAfter;
        tradeReports[reportId].complianceScore = compScore;
        tradeReports[reportId].securityTicker = ticker;
        tradeReports[reportId].reportedAt = block.timestamp;
        tradeReports[reportId].reviewed = false;
        tradeReports[reportId].flagged = false;
