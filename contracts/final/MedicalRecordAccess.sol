...
contract MedicalRecordAccess is ZamaEthereumConfig, AccessControl {
    ...
    function createRecord(
        ...
        euint16 riskIndex = FHE.mul(FHE.asEuint16(uint16(block.timestamp % 1000)), FHE.asEuint16(100)); // [arithmetic_overflow_underflow]
        euint16 adjustedIndex = FHE.sub(riskIndex, FHE.asEuint16(50)); // [arithmetic_overflow_underflow]
