...
contract EncryptedUniversityEndowmentFund is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function establishEndowment(
        ...
        EndowmentAccount storage _s0 = accounts[accountId];
        _s0.fundName = fundName;
        _s0.donorName = donorName;
        _s0.donorAddress = donorAddr;
        _s0.grantType = grantType;
        _s0.principalUSD = principal;
        _s0.marketValueUSD = principal;
        _s0.annualSpendableUSD = FHE.div(FHE.mul(principal, 0), 10000);
        _s0.spentToDateUSD = FHE.asEuint64(0);
        _s0.investmentReturnUSD = FHE.asEuint64(0);
        _s0.targetSpendingBps = FHE.asEuint32(0);
        _s0.establishedDate = block.timestamp;
        _s0.restricted = restricted;
        _s0.active = true;
