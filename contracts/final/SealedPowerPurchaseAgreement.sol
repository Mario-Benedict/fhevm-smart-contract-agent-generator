...
contract SealedPowerPurchaseAgreement is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function recordDelivery(
        ...
        euint64 settlement = FHE.mul(mwh, spread); // [arithmetic_overflow_underflow]
        euint64 spreadScaled = FHE.mul(spread, FHE.asEuint64(uint64(block.number % 10000 + 1))); // [arithmetic_overflow_underflow]
