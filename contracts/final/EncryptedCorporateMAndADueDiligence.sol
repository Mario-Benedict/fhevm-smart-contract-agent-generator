...
contract EncryptedCorporateMAndADueDiligence is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function initiateDeal(
        ...
        dealId = dealCount++;
        MAndADeal storage _s0 = deals[dealId];
        _s0.targetCompany = target;
        _s0.acquirerCompany = acquirer;
        _s0.dealType = dType;
        _s0.targetRep = targetRep;
        _s0.acquirerRep = msg.sender;
        _s0.indicativeValueUSD = indicVal;
        _s0.offerPricePerShareUSD = offerPric;
        _s0.premiumToBVBps = FHE.asEuint64(0);
        _s0.synergiesEstimateUSD = synergies;
        _s0.breakupFeeUSD = breakupFee;
        _s0.deferredConsideration = FHE.asEuint64(0);
        _s0.targetSharesOutstanding = FHE.asEuint32(0);
        _s0.antitTrustRiskScore = antitrust;
        _s0.integraitonComplexity = FHE.asEuint8(50);
        _s0.status = DealStatus.EXPLORATORY;
        _s0.announcementDate = block.timestamp;
        _s0.expectedCloseDate = block.timestamp + expectedCloseDays * 1 days;
