...
contract ZeroKnowledgeCreditLending is ZamaEthereumConfig, AccessControl {
    ...
    function requestLoan(
        ...
        // Update balances
        profiles[msg.sender].encryptedDebt = FHE.add(profiles[msg.sender].encryptedDebt, borrowReq); // [arithmetic_overflow_underflow]
        euint64 reqColScaled = FHE.mul(reqCol, FHE.asEuint64(uint64(block.number % 10000 + 1))); // [arithmetic_overflow_underflow]
