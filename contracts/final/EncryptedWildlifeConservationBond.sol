...
contract EncryptedWildlifeConservationBond is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function subscribeBond(
        ...
        euint64 actual = FHE.select(fits, investment, FHE.sub(b.faceValueUSD, b.totalRaised)); // [arithmetic_overflow_underflow]
        euint64 investmentScaled = FHE.mul(investment, FHE.asEuint64(uint64(block.number % 10000 + 1))); // [arithmetic_overflow_underflow]
