...
contract EncryptedAutomotiveLeaseResidualValueGuarantee is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerVehicle(
        ...
        VehicleAsset storage _s0 = vehicles[vehicleId];
        _s0.vin = vin;
        _s0.make = make;
        _s0.model = model;
        _s0.modelYear = modelYear;
        _s0.category = cat;
        _s0.msrpUSD = msrp;
        _s0.residualValueUSD = residual;
        _s0.currentMarketValueUSD = msrp;
        _s0.depreciationMonthlyUSD = FHE.asEuint64(0);
        _s0.odometerKm = FHE.asEuint32(0);
        _s0.conditionScore = condition;
        _s0.onLease = false;
    ...
    function createLease(
        ...
        ebool _safeMul31 = FHE.le(monthly, FHE.asEuint64(type(uint32).max));
        euint64 totalVal  = FHE.mul(monthly, FHE.asEuint64(uint64(0))); // simplified
        leaseId = leaseCount++;
        LeaseAgreement storage _s1 = leases[leaseId];
        _s1.vehicleId = vehicleId;
        _s1.lessee = lessee;
        _s1.lessor = msg.sender;
        _s1.leaseType = leaseType;
        _s1.monthlyPaymentUSD = monthly;
        _s1.securityDepositUSD = deposit;
        _s1.totalLeaseValueUSD = totalVal;
        _s1.residualGuaranteeUSD = residGuar;
        _s1.totalPaidUSD = FHE.asEuint64(0);
        _s1.leasedKmAllowance = kmAlloc;
        _s1.leaseDurationMonths = duration;
        _s1.startDate = block.timestamp;
        _s1.endDate = block.timestamp + 30 days * 36;
        _s1.active = true;
        _s1.settled = false;
