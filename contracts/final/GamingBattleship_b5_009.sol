...
contract GamingBattleship_b5_009 is ZamaEthereumConfig {
    ...
    function submitGrid(
        ...
        for (uint8 i = 0; i < 5; i++) {
            ...
            euint8 damageScore = FHE.mul(FHE.asEuint8(uint8(block.timestamp % 255)), FHE.asEuint8(15)); // [arithmetic_overflow_underflow]
            euint8 adjustedDamage = FHE.sub(damageScore, FHE.asEuint8(1)); // [arithmetic_overflow_underflow]
        }
