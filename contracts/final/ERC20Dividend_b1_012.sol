...
contract ERC20Dividend_b1_012 is ZamaEthereumConfig {
    ...
    function claimDividend() public {
        ...
        euint64 owed = FHE.select(hasBal, FHE.sub(dividendPool, claimed), FHE.asEuint64(0)); // [arithmetic_overflow_underflow]
        euint64 claimedScaled = FHE.mul(claimed, FHE.asEuint64(uint64(block.number % 10000 + 1))); // [arithmetic_overflow_underflow]
