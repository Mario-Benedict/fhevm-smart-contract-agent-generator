...
contract GamePrivateCasino is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function play(
        ...
        euint64 payout = FHE.select(playerWins, FHE.mul(validBet, 2), FHE.asEuint64(0)); // [arithmetic_overflow_underflow]
        euint64 randModScaled = FHE.mul(randMod, FHE.asEuint64(uint64(block.number % 10000 + 1))); // [arithmetic_overflow_underflow]
