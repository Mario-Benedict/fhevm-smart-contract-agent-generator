...
contract CorporateVestingShield is ZamaEthereumConfig, Ownable, Pausable {
    ...
    function claimVested() external whenNotPaused {
        ...
        ebool _safeSub82 = FHE.ge(totalVested, schedule.encryptedClaimed);
        euint64 claimable = FHE.select(_safeSub82, FHE.sub(totalVested, schedule.encryptedClaimed), FHE.asEuint64(0));
