...
contract EncryptedNFTRoyaltyAuction is ZamaEthereumConfig, Ownable {
    ...
    function createAuction(
        ...
        auctions[auctionId].currentOwner = msg.sender;
        auctions[auctionId].reservePrice = reserve;
        auctions[auctionId].highestBid = FHE.asEuint64(0);
        auctions[auctionId].highestBidder = address(0);
        auctions[auctionId].royaltyPct = royalty;
        auctions[auctionId].deadline = block.timestamp + durationHours * 1 hours;
