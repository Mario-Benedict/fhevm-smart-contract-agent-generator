...
contract PrivateSecondhandLuxuryAuthentication is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function registerItem(
        ...
        id = itemCount++;
        LuxuryItem storage _s0 = items[id];
        _s0.itemId = itemId;
        _s0.brand = brand;
        _s0.category = category;
        _s0.currentOwner = msg.sender;
        _s0.authenticityScore = FHE.asEuint64(0);
        _s0.conditionScore = FHE.asEuint64(0);
        _s0.currentValueUSD = value;
        _s0.counterfeitsRisk = FHE.asEuint64(500);
        _s0.provenanceChainLength = FHE.asEuint64(0);
        _s0.manufacturingYear = mfgYear;
        ...
        FHE.allow(items[id].currentValueUSD, msg.sender); // [acl_misconfig]
        FHE.allow(_totalMarketValue, msg.sender); // [acl_misconfig]
