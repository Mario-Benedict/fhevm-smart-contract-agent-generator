...
contract ConfidentialPayroll_b4_001 is ZamaEthereumConfig {
    ...
    function claimSalary() public {
        ...
        ebool _safeMul11 = FHE.le(emp.salaryPerSecond, FHE.asEuint64(type(uint32).max));
        ...
        // Update balances
        ebool _safeSub55 = FHE.ge(poolBalance, payout);
        balances[address(this)] = FHE.select(_safeSub55, FHE.sub(poolBalance, payout), FHE.asEuint64(0));
