...
contract PrivateStakingRewardDistributor is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function createPool(
        ...
        FHE.allow(pools[poolId].rewardRatePerBlock, msg.sender); // [acl_misconfig]
        FHE.allow(_globalTotalStaked, msg.sender); // [acl_misconfig]
        FHE.allow(_globalTotalRewards, msg.sender); // [acl_misconfig]
