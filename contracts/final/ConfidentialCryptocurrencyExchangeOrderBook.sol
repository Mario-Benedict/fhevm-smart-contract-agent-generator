...
contract ConfidentialCryptocurrencyExchangeOrderBook is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function submitOrder(
        ...
        orderId = orderCount++;
        Order storage _s0 = orders[orderId];
        _s0.pairId = pairId;
        _s0.trader = msg.sender;
        _s0.side = side;
        _s0.orderType = orderType;
        _s0.quantity = qty;
        _s0.limitPrice = price;
        _s0.filledQuantity = FHE.asEuint64(0);
        _s0.averageFillPrice = FHE.asEuint64(0);
        _s0.feesPaid = FHE.asEuint64(0);
        _s0.submissionTime = block.timestamp;
        _s0.expiryTime = block.timestamp + expiryDuration;
        _s0.status = OrderStatus.OPEN;
        // Update pair depth
