...
contract ConfidentialMilitaryPensionFundManager is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function updateDisabilityRating(
        ...
        ebool _safeSub47 = FHE.ge(_monthlyObligations, oldAdj);
        _monthlyObligations = FHE.select(_safeSub47, FHE.sub(_monthlyObligations, oldAdj), FHE.asEuint64(0));
    ...
    function distributePension(address veteran) external onlyOwner nonReentrant {
        ...
        ebool _safeSub48 = FHE.ge(_totalFundAssets, actual);
        _totalFundAssets = FHE.select(_safeSub48, FHE.sub(_totalFundAssets, actual), FHE.asEuint64(0));
    ...
    function activateSurvivorBenefit(address veteran) external onlyOwner {
        ...
        ebool _safeSub49 = FHE.ge(_monthlyObligations, v.monthlyPensionUSD);
        _monthlyObligations = FHE.select(_safeSub49, FHE.sub(_monthlyObligations, v.monthlyPensionUSD), FHE.asEuint64(0));
