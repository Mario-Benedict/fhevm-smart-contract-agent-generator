...
contract CovertDCA is ZamaEthereumConfig {
    ...
    function executeNextPeriod(address user) external {
        ...
        ebool _safeSub85 = FHE.ge(plan.encryptedTotalBudget, plan.encryptedAmountPerPeriod);
        plan.encryptedTotalBudget = FHE.select(_safeSub85, FHE.sub(plan.encryptedTotalBudget, plan.encryptedAmountPerPeriod), FHE.asEuint64(0));
