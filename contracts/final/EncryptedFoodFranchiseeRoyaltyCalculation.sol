...
contract EncryptedFoodFranchiseeRoyaltyCalculation is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function enrollFranchisee(
        ...
        FranchiseeProfile storage _s0 = franchisees[franchisee];
        _s0.weeklyGrossSales = FHE.asEuint64(0);
        _s0.monthlyGrossSales = FHE.asEuint64(0);
        _s0.ttmGrossSales = FHE.asEuint64(0);
        _s0.royaltyRateBps = royaltyRate;
        _s0.adFundRateBps = adFundRate;
        _s0.weeklyRoyaltyDue = FHE.asEuint64(0);
        _s0.weeklyAdFundDue = FHE.asEuint64(0);
        _s0.totalRoyaltiesPaid = FHE.asEuint64(0);
        _s0.totalAdFundContributions = FHE.asEuint64(0);
        _s0.pendingBalance = FHE.asEuint64(0);
        _s0.salesGrowthRate = FHE.asEuint64(0);
        _s0.regionalRankScore = FHE.asEuint64(0);
        _s0.performanceBand = PerformanceBand.MEETS_STANDARD;
        _s0.franchiseStartDate = block.timestamp;
        _s0.lastReportedWeek = 0;
        _s0.active = true;
        _s0.auditRequired = false;
