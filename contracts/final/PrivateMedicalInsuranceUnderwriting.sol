...
contract PrivateMedicalInsuranceUnderwriting is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function issuePolicy(
        ...
        euint64 totalPremium = FHE.add(basePremium, riskLoad); // [arithmetic_overflow_underflow]
        euint64 riskLoadScaled = FHE.mul(riskLoad, FHE.asEuint64(uint64(block.number % 10000 + 1))); // [arithmetic_overflow_underflow]
        ...
        FHE.allow(ph.annualPremiumUSD, holder); // [acl_misconfig]
