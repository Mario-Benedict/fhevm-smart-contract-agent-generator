...
contract GovernanceEncryptedQuadraticVoting is ZamaEthereumConfig, Ownable {
    ...
    function castQuadraticVote(
        ...
        v.voiceCredits = FHE.sub(v.voiceCredits, actualCost); // [arithmetic_overflow_underflow]
        euint64 actualCostScaled = FHE.mul(actualCost, FHE.asEuint64(uint64(block.number % 10000 + 1))); // [arithmetic_overflow_underflow]
