...
contract PrivateCemeteryMemorialPerpetualCare is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function purchaseIntermentRight(
        ...
        id = rightCount++;
        IntermentRight storage _s0 = rights[id];
        _s0.rightHolder = msg.sender;
        _s0.decedent = address(0);
        _s0.intermentType = intermentType;
        _s0.servicePackage = servicePackage;
        _s0.plotRef = plotRef;
        _s0.intermentRightPriceUSD = rightPrice;
        _s0.perpetualCareFeeUSD = perpetualCare;
        _s0.servicePackageCostUSD = servicePkg;
        _s0.prepaidMemorialUSD = prepaid;
        _s0.maintenanceScoreBps = FHE.asEuint16(10000);
        _s0.purchasedAt = block.timestamp;
        _s0.used = false;
