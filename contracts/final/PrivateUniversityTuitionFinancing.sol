...
contract PrivateUniversityTuitionFinancing is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function originateISA(
        ...
        FHE.allow(isa.fundingAmountUSD, student); // [acl_misconfig]
        FHE.allow(_totalFundingDeployed, msg.sender); // [acl_misconfig]
        FHE.allow(_totalRepayments, msg.sender); // [acl_misconfig]
