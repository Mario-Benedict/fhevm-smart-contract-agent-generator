...
contract PrivateUniversityAdmissions is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function submitApplication(
        ...
        id = applicationCount++;
        Application storage _s0 = applications[id];
        _s0.applicant = msg.sender;
        _s0.program = program;
        _s0.programName = programName;
        _s0.satScore = sat;
        _s0.gpaScore = gpa;
        _s0.essayScore = essay;
        _s0.extracurricularScore = extra;
        _s0.financialNeedUSD = income;
        _s0.aidOfferedUSD = FHE.asEuint64(0);
        _s0.overallRanking = FHE.asEuint16(0);
        _s0.submittedAt = block.timestamp;
        _s0.decision = AdmissionDecision.Pending;
        _s0.aidCalculated = false;
        FHE.allowThis(applications[id].satScore);
        FHE.allow(applications[id].satScore, msg.sender); // [acl_misconfig]
        FHE.allow(applications[id].satScore, msg.sender); // [acl_misconfig]
