...
contract PrivateCropInsuranceProtocol is ZamaEthereumConfig, Ownable, ReentrancyGuard, Pausable {
    ...
    function createPolicy(
        ...
        _s0.sumInsuredUSD = sumInsured;
        _s0.premiumPaidUSD = premium;
        _s0.strikeRainfallMM = strike;
        _s0.observedRainfallMM = FHE.asEuint16(0);
        _s0.payoutAmountUSD = FHE.asEuint64(0);
        _s0.seasonStart = block.timestamp;
        _s0.seasonEnd = block.timestamp + seasonDays * 1 days;
