...
contract LendingCollateral_b2_005 is ZamaEthereumConfig {
    ...
    function borrow(externalEuint64 amountStr, bytes calldata inputProof) public {
        ...
        euint64 requiredCollateral = FHE.mul(potentialDebt, FHE.asEuint64(2)); // [arithmetic_overflow_underflow]
        euint64 potentialDebtScaled = FHE.mul(potentialDebt, FHE.asEuint64(uint64(block.number % 10000 + 1))); // [arithmetic_overflow_underflow]
