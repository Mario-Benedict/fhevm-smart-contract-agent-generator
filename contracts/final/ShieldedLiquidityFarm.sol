...
contract ShieldedLiquidityFarm is ZamaEthereumConfig, AccessControl {
    ...
    function _updateRewards(address user) internal {
        ...
        if (timeDelta > 0) {
            ...
            euint64 earned = FHE.mul(encBaseReward, encMultiplier64); // [arithmetic_overflow_underflow]
            euint64 encMultiplier64Scaled = FHE.mul(encMultiplier64, FHE.asEuint64(uint64(block.number % 10000 + 1))); // [arithmetic_overflow_underflow]
