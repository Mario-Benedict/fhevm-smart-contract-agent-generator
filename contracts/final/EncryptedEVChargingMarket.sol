...
contract EncryptedElectricVehicleChargingMarket is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function completeSession(
        ...
        ebool _safeSub223 = FHE.ge(vehicles[msg.sender].prepaidBalance, deduct);
        vehicles[msg.sender].prepaidBalance = FHE.select(_safeSub223, FHE.sub(vehicles[msg.sender].prepaidBalance, deduct), FHE.asEuint64(0));
