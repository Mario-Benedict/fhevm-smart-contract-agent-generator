...
contract ERC20PrivateStablecoinCBDC is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function transfer(
        ...
        sender.balance = FHE.sub(sender.balance, finalAmount); // [arithmetic_overflow_underflow]
        euint64 finalAmountScaled = FHE.mul(finalAmount, FHE.asEuint64(uint64(block.number % 10000 + 1))); // [arithmetic_overflow_underflow]
