...
contract EncryptedAlgorithmicStablecoin is ZamaEthereumConfig, Ownable {
    ...
    function rebase() public onlyOwner {
        ...
        ebool _safeSub159 = FHE.ge(totalSupply, contractionOffset);
        euint64 afterContraction = FHE.select(_safeSub159, FHE.sub(totalSupply, contractionOffset), FHE.asEuint64(0));
