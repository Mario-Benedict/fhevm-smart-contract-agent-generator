...
contract ConfidentialExecutiveSalaryBand is ZamaEthereumConfig, AccessControl, ReentrancyGuard {
    ...
    function reviewSalary(
        ...
        ebool _safeSub37 = FHE.ge(_totalPayrollExposure, oldBase);
        _totalPayrollExposure = FHE.select(_safeSub37, FHE.sub(_totalPayrollExposure, oldBase), FHE.asEuint64(0));
