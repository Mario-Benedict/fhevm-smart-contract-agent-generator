...
contract EncryptedPrivateMembershipClub is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function joinClub(
        ...
        members[id].subscriptionFeeUSD = fee;
        members[id].rewardPoints = FHE.asEuint64(0);
        members[id].lifetimeSpendUSD = fee;
        members[id].accessPrivilegeBitfield = privileges;
        members[id].memberSince = block.timestamp;
