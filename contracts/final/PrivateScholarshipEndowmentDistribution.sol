...
contract PrivateScholarshipEndowmentDistribution is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function submitApplication(
        ...
        id = applicationCount++;
        ScholarshipApplication storage _s0 = applications[id];
        _s0.student = msg.sender;
        _s0.scholarshipType = scholarshipType;
        _s0.studentRef = studentRef;
        _s0.major = major;
        _s0.financialNeedScoreBps = finNeed;
        _s0.academicMeritScoreBps = acadMerit;
        _s0.donorMatchScoreBps = donorMatch;
        _s0.awardedAmountUSD = FHE.asEuint64(0);
        _s0.expectedFamilyContribBps = efc;
        _s0.status = AwardStatus.Applied;
        _s0.appliedAt = block.timestamp;
        _s0.academicYear = academicYear;
    ...
    function allowEndowmentStats(address viewer) external onlyOwner {
        FHE.allow(_totalScholarshipAwardedUSD, viewer); // [acl_misconfig]
        FHE.allow(_totalScholarshipAwardedUSD, msg.sender); // [acl_misconfig]
    }
