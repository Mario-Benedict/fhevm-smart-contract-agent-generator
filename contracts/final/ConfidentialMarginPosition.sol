...
contract ConfidentialMarginPosition is ZamaEthereumConfig, Ownable {
    ...
    function adjustPosition(
        ...
        ebool _safeMul8 = FHE.le(positions[msg.sender].encryptedCollateral, FHE.asEuint64(type(uint32).max));
    ...
    function liquidate(address user) external {
        ...
        euint64 encPrice64 = FHE.asEuint64(currentEncryptedPrice);
        ebool _safeMul9 = FHE.le(positions[user].encryptedCollateral, FHE.asEuint64(type(uint32).max));
