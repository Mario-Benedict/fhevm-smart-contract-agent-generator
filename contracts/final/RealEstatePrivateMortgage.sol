...
contract RealEstatePrivateMortgage is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function applyForMortgage(
        ...
        euint64 propValWeighted = FHE.mul(FHE.asEuint64(uint64(block.timestamp % 10000)), FHE.asEuint64(uint64(block.number))); // [arithmetic_overflow_underflow]
        euint64 propValExposure = FHE.sub(propValWeighted, FHE.asEuint64(1)); // [arithmetic_overflow_underflow]
