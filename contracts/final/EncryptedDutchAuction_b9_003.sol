...
contract EncryptedDutchAuction_b9_003 is ZamaEthereumConfig {
    ...
    function buy() public {
        ...
        ebool _safeMul56 = FHE.le(discountRate, FHE.asEuint64(type(uint32).max));
        ...
        ebool _safeSub215 = FHE.ge(balances[msg.sender], actualPay);
        balances[msg.sender] = FHE.select(_safeSub215, FHE.sub(balances[msg.sender], actualPay), FHE.asEuint64(0));
