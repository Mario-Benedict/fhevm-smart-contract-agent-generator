...
contract EncryptedPrivateBankingWealth is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function onboardClient(
        ...
        WealthProfile storage _s0 = profiles[client];
        _s0.clientCode = clientCode;
        _s0.aumUSD = aum;
        _s0.liquidAssetUSD = liquid;
        _s0.realEstateValueUSD = realEstate;
        _s0.alternativesUSD = alts;
        _s0.riskScore = riskScore;
        _s0.annualFeeUSD = fee;
        _s0.unrealizedGainUSD = FHE.asEuint64(0);
        _s0.riskProfile = riskProfile;
        _s0.tier = tier;
        _s0.relationshipManager = msg.sender;
        _s0.onboardedAt = block.timestamp;
        _s0.active = true;
