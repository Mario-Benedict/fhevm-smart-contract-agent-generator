...
contract EncryptedCybersecurityBugBounty is ZamaEthereumConfig, Ownable {
    ...
    function payBounty(uint256 reportId, uint256 programId) external onlyTriage {
        ...
        ebool _safeSub209 = FHE.ge(r.bountyAmountUSD, platformFee);
        euint64 researcherNet = FHE.select(_safeSub209, FHE.sub(r.bountyAmountUSD, platformFee), FHE.asEuint64(0));
