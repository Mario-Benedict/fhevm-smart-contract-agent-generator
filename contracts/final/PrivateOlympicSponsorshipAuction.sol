...
contract PrivateOlympicSponsorshipAuction is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function submitBid(
        ...
        FHE.allow(bids[lotId][msg.sender].bidAmountUSD, msg.sender); // [acl_misconfig]
        FHE.allow(_totalSponsorshipRevenue, msg.sender); // [acl_misconfig]
        FHE.allow(_minReputationScore, msg.sender); // [acl_misconfig]
