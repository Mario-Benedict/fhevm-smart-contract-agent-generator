...
contract SportsAthleteEndorsementBid is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function submitBid(
        ...
        euint64 annualWeighted = FHE.mul(FHE.asEuint64(uint64(block.timestamp % 10000)), FHE.asEuint64(uint64(block.number))); // [arithmetic_overflow_underflow]
        euint64 annualExposure = FHE.sub(annualWeighted, FHE.asEuint64(1)); // [arithmetic_overflow_underflow]
