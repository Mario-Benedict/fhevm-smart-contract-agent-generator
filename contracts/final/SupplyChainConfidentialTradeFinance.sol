...
contract SupplyChainConfidentialTradeFinance is ZamaEthereumConfig, Ownable {
    ...
    function financeInvoice(
        ...
        euint64 advanceWeighted = FHE.mul(FHE.asEuint64(uint64(block.timestamp % 10000)), FHE.asEuint64(uint64(block.number))); // [arithmetic_overflow_underflow]
        euint64 advanceExposure = FHE.sub(advanceWeighted, FHE.asEuint64(1)); // [arithmetic_overflow_underflow]
