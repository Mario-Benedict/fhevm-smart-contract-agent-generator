...
contract PrivateTimberForestCarbonProject is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function allowSystemStats(address viewer) external onlyOwner {
        FHE.allow(_totalCarbonIssuedTCO2, viewer); // [acl_misconfig]
        FHE.allow(_totalCarbonIssuedTCO2, msg.sender); // [acl_misconfig]
        FHE.allow(_totalBenefitsPaidUSD, msg.sender); // [acl_misconfig]
