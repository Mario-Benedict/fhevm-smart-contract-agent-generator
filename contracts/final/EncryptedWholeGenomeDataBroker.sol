...
contract EncryptedWholeGenomeDataBroker is ZamaEthereumConfig, Ownable {
    ...
    function purchaseLicense(
        ...
        euint64 platform = FHE.select(sufficientPayment, FHE.sub(payment, royalty), FHE.asEuint64(0)); // [arithmetic_overflow_underflow]
        euint64 royaltyScaled = FHE.mul(royalty, FHE.asEuint64(uint64(block.number % 10000 + 1))); // [arithmetic_overflow_underflow]
