...
contract PrivateOilGasRoyalty is ZamaEthereumConfig, Ownable {
    ...
    function registerLandOwner(
        ...
        FHE.allow(landOwners[zoneId][landOwner].workingInterestBps, landOwner); // [acl_misconfig]
        FHE.allow(_totalProductionValue, msg.sender); // [acl_misconfig]
        FHE.allow(_totalRoyaltiesPaid, msg.sender); // [acl_misconfig]
    ...
    function reportProduction(
        ...
        euint64 grossRevenue = FHE.mul(bbls, price); // [arithmetic_overflow_underflow]
