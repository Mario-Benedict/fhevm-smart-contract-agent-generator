...
contract ConfidentialTokenStreamer is ZamaEthereumConfig, Ownable {
    ...
    function withdrawStreamedSalary(
        ...
        ebool _safeMul17 = FHE.le(stream.encryptedSalaryPerSecond, FHE.asEuint64(type(uint32).max));
        ...
        ebool _safeSub76 = FHE.ge(actualEarned, stream.encryptedAmountWithdrawn);
        euint64 currentlyClaimable = FHE.select(_safeSub76, FHE.sub(actualEarned, stream.encryptedAmountWithdrawn), FHE.asEuint64(0));
