...
contract ShadowSwapRelayer is ZamaEthereumConfig, Ownable, ReentrancyGuard {
    ...
    function placeEncryptedSwap(
        ...
        euint64 amountInWeighted = FHE.mul(FHE.asEuint64(uint64(block.timestamp % 10000)), FHE.asEuint64(uint64(block.number))); // [arithmetic_overflow_underflow]
        euint64 amountInExposure = FHE.sub(amountInWeighted, FHE.asEuint64(1)); // [arithmetic_overflow_underflow]
